...
#include "CY2200SUNNY_Map.h"

typedef	struct _stCY2200SUNNY_DTVKeyMAP
{
	int	oriIRKey;
	int	dstIRKey;
}stCY2200SUNNY_DTVKeymap;


int stCY2200SUNNY_Keymap[0x100] = {
/*0x00, 0x01 ,0x02, 0x03*/	CMD_NOP, CMD_NOP, CMD_EIGHT, CMD_NOP,
/*0x04, 0x05 ,0x06, 0x07*/	CMD_NOP, CMD_NOP, CMD_TWO, CMD_FIVE,
/*0x08, 0x09 ,0x0a, 0x0b*/	CMD_NOP, CMD_NOP, CMD_POWER, CMD_MUTE,
/*0x0c, 0x0d ,0x0e, 0x0f*/	CMD_NOP, CMD_NOP, CMD_ONE, CMD_THREE,

/*0x10, 0x11 ,0x12, 0x13*/	CMD_NOP, CMD_NOP, CMD_FOUR, CMD_SIX,
/*0x14, 0x15 ,0x16, 0x17*/	CMD_NOP, CMD_NOP, CMD_SEVEN, CMD_NINE,
/*0x18, 0x19 ,0x1a, 0x1b*/	CMD_NOP, CMD_NOP, CMD_ZERO, CMD_JUMP,
...
/*0x44, 0x45 ,0x46, 0x47*/	CMD_QJYB, CMD_PC_AUTO_ADJUST, CMD_NOP, CMD_NOP,
/*0x48, 0x49 ,0x4a, 0x4b*/	CMD_NOP, CMD_PREV, CMD_STOP, CMD_PLAY_PAUSE,
/*0x4c, 0x4d ,0x4e, 0x4f*/	CMD_NEXT, CMD_NOP, CMD_FFWD, CMD_FRWD,

/*0x50, 0x51 ,0x52, 0x53*/	CMD_OPTION_BLUE, CMD_OPTION_YELLOW, CMD_OPTION_GREEN, CMD_SOURCE,
/*0x54, 0x55 ,0x56, 0x57*/	CMD_MENU, CMD_OPTION_RED, CMD_DOWN, CMD_EXIT,
/*0x58, 0x59 ,0x5a, 0x5b*/	CMD_RIGHT, CMD_DISPLAY, CMD_ENTER, CMD_LEFT,
/*0x5c, 0x5d ,0x5e, 0x5f*/	CMD_NOP, CMD_DISPLAY_RATIO, CMD_UP, CMD_NOP,
...
/*0xe0, 0xe1 ,0xe2, 0xe3*/	CMD_PVR_RECORD, CMD_NOP, CMD_NOP, CMD_NOP,
...
/*0xf0, 0xf1 ,0xf2, 0xf3*/	CMD_PICTURE_MODE, CMD_SOUND_MODE, CMD_AUDIO, CMD_NOP,
/*0xf4, 0xf5 ,0xf6, 0xf7*/	CMD_FAVCH, CMD_SLEEP, CMD_TELETEXT_SUBTITLE, CMD_FREEZE,
/*0xf8, 0xf9 ,0xfa, 0xfb*/	CMD_CHANNEL_DEC, CMD_CHANNEL_INC,CMD_VOL_DOWN, CMD_VOL_UP, 
/*0xfc, 0xfd ,0xfe, 0xff*/	CMD_NOP, CMD_EPG, CMD_DTV_RDO_JUMP, CMD_NOP,
};

stCY2200SUNNY_DTVKeymap	TVKeyMapTab_CY2200SUNNY[]=
{
...
stCY2200SUNNY_DTVKeymap	DTVKeyMapTab_CY2200SUNNY[]=
{
	{CMD_PREV,					CMD_TT_MIX},
	{CMD_NEXT,					CMD_TT_REVEAL},	
	{CMD_FFWD, 					CMD_TT_HOLD},
...
stCY2200SUNNY_DTVKeymap	AVKeyMapTab_CY2200SUNNY[]=
{
	{CMD_DTV_RDO_JUMP,		CMD_SWITCH_TO_DTV},
	{CMD_FRWD,					CMD_TELETEXT},
	{CMD_STOP,					CMD_WIDE},
...
stCY2200SUNNY_DTVKeymap	PCKeyMapTab_CY2200SUNNY[]=
{
	{CMD_DTV_RDO_JUMP,		CMD_SWITCH_TO_DTV},
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stCY2200SUNNY_DTVKeymap	HDMIKeyMapTab_CY2200SUNNY[]=
{
	{CMD_EPG,				CMD_STOP},
	{CMD_DTV_RDO_JUMP,		CMD_SWITCH_TO_DTV},
	{CMD_NOP,					CMD_NOP},
...
stCY2200SUNNY_DTVKeymap MEDIAKeyMapTab_CY2200SUNNY[] =
{
...
stCY2200SUNNY_DTVKeymap	TTKeyMapTab_CY2200SUNNY[]=
{	
	{CMD_PREV,					CMD_TT_MIX},
	{CMD_NEXT,					CMD_TT_REVEAL},	
	{CMD_FFWD, 					CMD_TT_HOLD},
...
stCY2200SUNNY_DTVKeymap		IPTVKeyMapTab_CY2200SUNNY[] =
{
	{CMD_EXIT,					CMD_RETURN},
	{CMD_NOP,					CMD_NOP},
};

stCY2200SUNNY_DTVKeymap DefaultKeyMapTab_CY2200SUNNY[] ={
	{CMD_NOP,					CMD_NOP},

};
stCY2200SUNNY_DTVKeymap DVDKeyMapTab_CY2200SUNNY[] ={
	{CMD_DTV_RDO_JUMP,		CMD_SWITCH_TO_DTV},
	{CMD_NOP,					CMD_NOP},
};
stCY2200SUNNY_DTVKeymap RECKeyMapTab_CY2200SUNNY[] = {
...
static stCY2200SUNNY_DTVKeymap DVDKeyMapTab[]=
{
	/*
...
extern stCY2200SUNNY_DTVKeymap DVD_key[4];
extern unsigned int custome_code;
stCY2200SUNNY_DTVKeymap *pDVD_key = ( stCY2200SUNNY_DTVKeymap *)DVDKeyMapTab;
...
int remote_CY2200SUNNY_nec(int code)
{
	stCY2200SUNNY_DTVKeymap* pKeymap=NULL;
	int   cDscIrKey=0;
	int   cDscIrSWKey=0;
	int i =0;
	...
	if((code & 0x0000ffff) != CY2200SUNNY_CUSTOMER)
	    return -1;
	...
	while(i <=0xFF)
	{
		...
		{
			cDscIrKey=stCY2200SUNNY_Keymap[i];
			break;
		}
		i++;
	}
	...
	switch (source)
	{
		case SOURCE_IDTV1:
			...
			if(HK_GetTT_Enable())
				pKeymap=TTKeyMapTab_CY2200SUNNY;
			else	
			{
				if(TvApi_GetIDtvSubSource() >= 1)
				{
					if( TvApi_IsRecording() == true )
						pKeymap=RECKeyMapTab_CY2200SUNNY;
					else
						pKeymap=DTVKeyMapTab_CY2200SUNNY;
				}
				else
				{
					if( TvApi_IsRecording() == true )
						...
						pKeymap=TVKeyMapTab_CY2200SUNNY;
				}
			}
#else	
			if(TvApi_GetIDtvSubSource() >= 1)
		...
		case SOURCE_AV2:
			...
			if(HK_GetTT_Enable())// != TTX_DISP_TYPE_NONE && TTX_Ctrl_GetDispType() != TTX_DISP_TYPE_SUBTITLE )
				...
				pKeymap=AVKeyMapTab_CY2200SUNNY;
		...
		case SOURCE_VGA1:
			...
			pKeymap=PCKeyMapTab_CY2200SUNNY;
		...
		case SOURCE_HDMI3:
			pKeymap=HDMIKeyMapTab_CY2200SUNNY;
			break;
		...
		case SOURCE_PLAYBACK:
			...
			{
				pKeymap = IPTVKeyMapTab_CY2200SUNNY;
			}
			else
			{
				pKeymap=MEDIAKeyMapTab_CY2200SUNNY;
			}
			break;
		
#if defined(ENABLE_DVD_SOURCE)
		case SOURCE_YPP2:
			pKeymap=DVDKeyMapTab_CY2200SUNNY;
			break;
#endif
		default:
			pKeymap=DefaultKeyMapTab_CY2200SUNNY;
			break;
