...
typedef	struct _stRJK72_DTVKeyMAP
{
	int	oriIRKey;
	int	dstIRKey;
}stRJK72_DTVKeymap;

int stRJK72_Keymap[0x100] = {
...
/*0x14, 0x15 ,0x16, 0x17*/	CMD_DOWN, CMD_EXIT, CMD_MENU, CMD_FREEZE,
/*0x18, 0x19 ,0x1a, 0x1b*/	CMD_EPG, CMD_NOP, CMD_NOP, CMD_AUDIO,
/*0x1c, 0x1d ,0x1e, 0x1f*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_NOP,

/*0x20, 0x21 ,0x22, 0x23*/	CMD_NOP, CMD_TELETEXT_SUBTITLE, CMD_NOP, CMD_NOP,
...
/*0x40, 0x41 ,0x42, 0x43*/	CMD_DISPLAY, CMD_PICTURE_MODE, CMD_SOUND_MODE, CMD_SLEEP,
/*0x44, 0x45 ,0x46, 0x47*/	CMD_ZOOM, CMD_NOP, CMD_NOP, CMD_NOP,
...
/*0x50, 0x51 ,0x52, 0x53*/	CMD_NOP, CMD_PLAY, CMD_STOP, CMD_NOP,
/*0x54, 0x55 ,0x56, 0x57*/	CMD_PREV, CMD_NEXT, CMD_FRWD, CMD_FFWD,
/*0x58, 0x59 ,0x5a, 0x5b*/	CMD_USB, CMD_NOP, CMD_NOP, CMD_NOP,
...
stRJK72_DTVKeymap		TVKeyMapTab_RJK72[]=
{
	{CMD_TELETEXT_SUBTITLE,		CMD_STITLE},
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--start
stRJK72_DTVKeymap		DTVKeyMapTab_RJK72[]=
{
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--end
stRJK72_DTVKeymap		AVKeyMapTab_RJK72[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stRJK72_DTVKeymap		PCKeyMapTab_RJK72[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stRJK72_DTVKeymap		HDMIKeyMapTab_RJK72[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stRJK72_DTVKeymap		MEDIAKeyMapTab_RJK72[]=
{
	//{CMD_MENU, 					CMD_QUICK},
	//{CMD_EXIT,					CMD_RETURN},
	//{CMD_TT_TXCL,				CMD_NOP},
...
stRJK72_DTVKeymap		DVDKeyMapTab_RJK72[]=
{	// IR_CMD				DVD_CODE
	{CMD_MUTE,					0x003C},
	{CMD_NOP,					CMD_NOP},
};
stRJK72_DTVKeymap		DefaultKeyMapTab_RJK72[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};	

stRJK72_DTVKeymap		TTKeyMapTab_RJK72[]=
{
...
stRJK72_DTVKeymap		RECKeyMapTab_RJK72[]=
{
	{CMD_NOP,					CMD_NOP},
};
...
static stRJK72_DTVKeymap DVDKeyMapTab[]=
{
...
/*************************************************************************************************************************************/
extern stRJK72_DTVKeymap DVD_key[4];
extern unsigned int custome_code;
stRJK72_DTVKeymap *pDVD_key = ( stRJK72_DTVKeymap *)DVDKeyMapTab;
...
int remote_RJK72_nec(int code)
{
	stRJK72_DTVKeymap* pKeymap=NULL;
	int   cDscIrKey=0;
	int   cDscIrSWKey=0;
	int i =0;
	...
	if((code & 0x0000ffff) != RJK72_CUSTOMER)
	    return -1;
	...
	switch (source)
	{
			...
			//add by lq@2014.12.16--start
			{
				if(TvApi_GetIDtvSubSource() >= 1)
				{
					if( TvApi_IsRecording() == true )
						pKeymap=RECKeyMapTab_RJK72;
					else
						pKeymap=DTVKeyMapTab_RJK72;
				}
				else
				{
					if( TvApi_IsRecording() == true )
		...
		case SOURCE_HDMI3:
			pKeymap=HDMIKeyMapTab_RJK72;
			break;
		
		case SOURCE_BROWSER:
		case SOURCE_OSD:
		case SOURCE_PLAYBACK://add by zjl@2014.06.11
			pKeymap=MEDIAKeyMapTab_RJK72;
			break;
...
#endif
		default:
			pKeymap=DefaultKeyMapTab_RJK72;
			break;
