...
#include "KTRONICS_Map.h"

int stKTRONICS_Keymap[0x100] = {
...
int remote_KTRONICS_nec(int code)
{
	...
	if((code & 0x0000ffff) != KTRONICS_CUSTOMER)
	{
		return -1;
    }
	switch((code & 0x00ff0000)>>16) 
	{
		...
		case 0xD2:
			return CMD_FAC_MANUAL_SEARCHCH;
		case 0x08:
			return CMD_FAC_F1;
		...
		case 0xFC:
		//case 0x89:
			/*import DTV preset channels.*/
			return CMD_PRESET_DTV;
			break;		
		case 0xFD:
		...
		/*add by zjl@2015.08.18--for auto test at factory.*/
	    //Add by wangld @ 2017.10.12 --start
		case 0xDE:
		case 0x83:
		...
		case 0xC8:
			return CMD_SOURCE_DTV_ATV_JUMP;	
		 //Add by wangld @ 2017.10.12 --end
		default:   return -1;
	}
}
