...
typedef	struct _stBD31_DTVKeyMAP
{
	int	oriIRKey;
	int	dstIRKey;
}stBD31_DTVKeymap;

int stBD31_Keymap[0x100] = {
/*0x00, 0x01 ,0x02, 0x03*/	CMD_VOL_UP, CMD_VOL_DOWN, CMD_CHANNEL_INC, CMD_CHANNEL_DEC,
/*0x04, 0x05 ,0x06, 0x07*/	CMD_NOP, CMD_POWER, CMD_UP, CMD_DOWN,
/*0x08, 0x09 ,0x0a, 0x0b*/	CMD_SLEEP, CMD_NOP, CMD_NOP, CMD_MUTE,
/*0x0c, 0x0d ,0x0e, 0x0f*/	CMD_JUMP, CMD_NOP, CMD_NOP, CMD_NOP,

/*0x10, 0x11 ,0x12, 0x13*/	CMD_ZERO, CMD_ONE, CMD_TWO, CMD_THREE,
/*0x14, 0x15 ,0x16, 0x17*/	CMD_FOUR, CMD_FIVE, CMD_SIX, CMD_SEVEN,
/*0x18, 0x19 ,0x1a, 0x1b*/	CMD_EIGHT, CMD_NINE, CMD_DISPLAY, CMD_NOP,
/*0x1c, 0x1d ,0x1e, 0x1f*/	CMD_NOP, CMD_NOP, CMD_PICTURE_MODE, CMD_NOP,

/*0x20, 0x21 ,0x22, 0x23*/	CMD_NOP, CMD_SOURCE, CMD_PLAYATTIME, CMD_EPG,
/*0x24, 0x25 ,0x26, 0x27*/	CMD_TELETEXT_SUBTITLE, CMD_NOP, CMD_NOP, CMD_NOP,
/*0x28, 0x29 ,0x2a, 0x2b*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_NOP,
/*0x2c, 0x2d ,0x2e, 0x2f*/	CMD_DISPLAY_RATIO, CMD_NOP, CMD_NOP, CMD_NOP,

/*0x30, 0x31 ,0x32, 0x33*/	CMD_REPEAT, CMD_STOP, CMD_NOP, CMD_TELETEXT,
/*0x34, 0x35 ,0x36, 0x37*/	CMD_OPTION_RED, CMD_SOUND_MODE, CMD_OPTION_GREEN, CMD_OPTION_BLUE,
/*0x38, 0x39 ,0x3a, 0x3b*/	CMD_OPTION_YELLOW, CMD_LIST, CMD_NOP, CMD_FAVCH,
/*0x3c, 0x3d ,0x3e, 0x3f*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_NOP,

/*0x40, 0x41 ,0x42, 0x43*/	CMD_EXIT, CMD_LEFT, CMD_ENTER, CMD_RIGHT,
/*0x44, 0x45 ,0x46, 0x47*/	CMD_AUDIO, CMD_NOP, CMD_NOP, CMD_MENU,
/*0x48, 0x49 ,0x4a, 0x4b*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_NOP,
/*0x4c, 0x4d ,0x4e, 0x4f*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_NOP,

/*0x50, 0x51 ,0x52, 0x53*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_DTV_RDO_JUMP,
...
stBD31_DTVKeymap		TVKeyMapTab_BD31[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--start
stBD31_DTVKeymap		DTVKeyMapTab_BD31[]=
{
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--end
stBD31_DTVKeymap		AVKeyMapTab_BD31[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stBD31_DTVKeymap		PCKeyMapTab_BD31[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stBD31_DTVKeymap		HDMIKeyMapTab_BD31[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stBD31_DTVKeymap		MEDIAKeyMapTab_BD31[]=
{
	{CMD_TELETEXT,					CMD_PLAY_PAUSE},
	{CMD_OPTION_RED,					CMD_PREV},
	{CMD_OPTION_GREEN,					CMD_NEXT},
	{CMD_OPTION_YELLOW,					CMD_FRWD},
	{CMD_OPTION_BLUE,					CMD_FFWD},
	{CMD_PLAYATTIME,					CMD_OPTION_GREEN},
	{CMD_MENU, 					CMD_QUICK},
	{CMD_EXIT,					CMD_RETURN},
	{CMD_NOP,					CMD_NOP},
};
stBD31_DTVKeymap		DVDKeyMapTab_BD31[]=
{	// IR_CMD				DVD_CODE
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stBD31_DTVKeymap		DefaultKeyMapTab_BD31[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};	

stBD31_DTVKeymap		TTKeyMapTab_BD31[]=
{
	{CMD_PICTURE_MODE,	CMD_TT_INDEX},
	{CMD_SOUND_MODE,	CMD_TT_REVEAL},
...
stBD31_DTVKeymap		RECKeyMapTab_BD31[]=
{
	{CMD_TELETEXT,					CMD_PLAY_PAUSE},
	{CMD_OPTION_RED,					CMD_PREV},
	{CMD_OPTION_GREEN,					CMD_NEXT},
...
static stBD31_DTVKeymap DVDKeyMapTab[]=
{
...
/*************************************************************************************************************************************/
extern stBD31_DTVKeymap DVD_key[4];
extern unsigned int custome_code;
stBD31_DTVKeymap *pDVD_key = ( stBD31_DTVKeymap *)DVDKeyMapTab;
bool load_dvd_code ( void )
{
	...
	for(;;)
	{
		...
		{
			DVD_key[0].dstIRKey =  pDVD_key[i].dstIRKey;		//替换成DVD命令值
			pDVD_key[i].oriIRKey = CMD_SOURCE_YPP2;		//what?
...
int remote_BD31_nec(int code)
{
	stBD31_DTVKeymap* pKeymap=NULL;
	int   cDscIrKey=0;			//保存命令值
	int   cDscIrSWKey=0;
	int i =0;
	...
	if((code & 0x0000ffff) != BD31_CUSTOMER)		//匹配客户码
	    return -1;

	while(i <=0xFF) //modify by zjl@2014.10.22		//匹配键值
	{
		if(i == ((code & 0x00ff0000) >> 16))		//键值转命令值
		{
			cDscIrKey=stBD31_Keymap[i];
			break;
		}
		i++;
	}
	...
	switch (source)								//选通道
	{
		case SOURCE_IDTV1:								//DTV_MODE?
#if (defined CONFIG_VBI_TTX)
			if(HK_GetTT_Enable())						//TT_MODE?
				pKeymap=TTKeyMapTab_BD31;
			else	
			//add by lq@2014.12.16--start
			{
				if(TvApi_GetIDtvSubSource() >= 1)
				{
					if( TvApi_IsRecording() == true )	//REC_MODE?
						pKeymap=RECKeyMapTab_BD31;
					else
						pKeymap=DTVKeyMapTab_BD31;
				}
				else
				{
		...
		case SOURCE_HDMI3:
			pKeymap=HDMIKeyMapTab_BD31;
			break;
		
		case SOURCE_BROWSER:
		case SOURCE_OSD:
		case SOURCE_PLAYBACK://add by zjl@2014.06.11			//MEDIA_MODE?
			pKeymap=MEDIAKeyMapTab_BD31;
			break;
	...
	while(pKeymap[i].oriIRKey	!=	CMD_NOP)
	{
		...
		{
			cDscIrSWKey = pKeymap[i].dstIRKey;		//替换成复用功能
