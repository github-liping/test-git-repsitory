...
typedef	struct _stSS1_DTVKeyMAP
{
	int	oriIRKey;
	int	dstIRKey;
}stSS1_DTVKeymap;

int stSS1_Keymap[0x100] = {
/*0x00, 0x01 ,0x02, 0x03*/	CMD_ONE, CMD_TWO, CMD_THREE, CMD_POWER,
/*0x04, 0x05 ,0x06, 0x07*/	CMD_FOUR, CMD_FIVE, CMD_SIX, CMD_MUTE,
/*0x08, 0x09 ,0x0a, 0x0b*/	CMD_SEVEN, CMD_EIGHT, CMD_NINE, CMD_NOP,
/*0x0c, 0x0d ,0x0e, 0x0f*/	CMD_SOURCE, CMD_ZERO, CMD_JUMP, CMD_FREEZE,

/*0x10, 0x11 ,0x12, 0x13*/	CMD_SLEEP, CMD_AUDIO, CMD_DISPLAY_RATIO, CMD_DISPLAY,
/*0x14, 0x15 ,0x16, 0x17*/	CMD_OPTION_GREEN, CMD_TELETEXT, CMD_OPTION_BLUE, CMD_NOP,
/*0x18, 0x19 ,0x1a, 0x1b*/	CMD_OPTION_RED, CMD_EPG, CMD_OPTION_YELLOW, CMD_NOP,
#if defined(ENABLE_TTX_SUBPAGE_BEHAVIOR_2)

#if defined(SIMPLE_RECORD)
/*0x1c, 0x1d ,0x1e, 0x1f*/	CMD_PICTURE_MODE, CMD_CHANNEL_INC, CMD_MENU, CMD_NOP,
#else
...
/*0x40, 0x41 ,0x42, 0x43*/	CMD_VOL_DOWN, CMD_NOP, CMD_VOL_UP, CMD_NOP,
#if defined(SIMPLE_RECORD)
/*0x44, 0x45 ,0x46, 0x47*/	CMD_SOUND_MODE, CMD_CHANNEL_DEC, CMD_EXIT, CMD_NOP,
#else
/*0x44, 0x45 ,0x46, 0x47*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_NOP,
#endif
/*0x48, 0x49 ,0x4a, 0x4b*/	CMD_TT_INDEX, CMD_FAVCH, CMD_TT_REVEAL, CMD_NOP,
/*0x4c, 0x4d ,0x4e, 0x4f*/	CMD_OPTION_SUBPAGE, CMD_PVR_TIMESHIFT, CMD_TT_HOLD, CMD_NOP,

/*0x50, 0x51 ,0x52, 0x53*/	CMD_TELETEXT_SUBTITLE, CMD_DTV_RDO_JUMP, CMD_FRWD, CMD_UP,
/*0x54, 0x55 ,0x56, 0x57*/	CMD_FFWD, CMD_PLAY_PAUSE, CMD_LEFT, CMD_ENTER,
/*0x58, 0x59 ,0x5a, 0x5b*/	CMD_RIGHT, CMD_STOP, CMD_PREV, CMD_DOWN,
/*0x5c, 0x5d ,0x5e, 0x5f*/	CMD_TT_TIME, CMD_PVR_RECORD, CMD_PVR_FILE_LIST, CMD_NOP,
...
stSS1_DTVKeymap		TVKeyMapTab_SS1[]=
{
...
stSS1_DTVKeymap		DTVKeyMapTab_SS1[]=
{
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--end
stSS1_DTVKeymap		AVKeyMapTab_SS1[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stSS1_DTVKeymap		PCKeyMapTab_SS1[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stSS1_DTVKeymap		HDMIKeyMapTab_SS1[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stSS1_DTVKeymap		MEDIAKeyMapTab_SS1[]=
{
	{CMD_MENU, 					CMD_QUICK},
	{CMD_EXIT,					CMD_RETURN},
	{CMD_TT_REVEAL,				CMD_NOP},
	{CMD_TT_HOLD,				CMD_NOP},
	{CMD_TT_TIME,				CMD_NEXT},
	{CMD_NOP,					CMD_NOP}
	
};
stSS1_DTVKeymap		DVDKeyMapTab_SS1[]=
{	// IR_CMD				DVD_CODE
	{CMD_MUTE,					0x003C},
	{CMD_NOP,					CMD_NOP},
};
stSS1_DTVKeymap		DefaultKeyMapTab_SS1[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};	

stSS1_DTVKeymap		TTKeyMapTab_SS1[]=
{
	{CMD_PREV,				    CMD_TT_MIX},
	{CMD_FFWD, 				    CMD_WIDE},
	//{CMD_NEXT,					CMD_TT_TIME},
	{CMD_NOP,					CMD_NOP},
};

//add by lq@2014.12.16--start
stSS1_DTVKeymap		RECKeyMapTab_SS1[]=
{
    {CMD_TT_TIME,				CMD_NEXT},
	{CMD_NOP,					CMD_NOP},
};
...
static stSS1_DTVKeymap DVDKeyMapTab[]=
{
...
/*************************************************************************************************************************************/
extern stSS1_DTVKeymap DVD_key[4];
extern unsigned int custome_code;
stSS1_DTVKeymap *pDVD_key = ( stSS1_DTVKeymap *)DVDKeyMapTab;
...
int remote_SS1_nec(int code)
{
	stSS1_DTVKeymap* pKeymap=NULL;
	int   cDscIrKey=0;
	int   cDscIrSWKey=0;
	int i =0;
	...
	if((code & 0x0000ffff) != SS1_CUSTOMER)
	    return -1;
	...
	switch (source)
	{
			...
			//add by lq@2014.12.16--start
			{
				if(TvApi_GetIDtvSubSource() >= 1)
				{
					if( TvApi_IsRecording() == true )
						pKeymap=RECKeyMapTab_SS1;
					else
						pKeymap=DTVKeyMapTab_SS1;
				}
				else
				{
					if( TvApi_IsRecording() == true )
		...
		case SOURCE_HDMI3:
			pKeymap=HDMIKeyMapTab_SS1;
			break;
		
		case SOURCE_BROWSER:
		case SOURCE_OSD:
		case SOURCE_PLAYBACK://add by zjl@2014.06.11
			pKeymap=MEDIAKeyMapTab_SS1;
			break;
