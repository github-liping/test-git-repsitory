...
#include "KIMURA_Map.h"

typedef	struct _stKIMURA_DTVKeyMAP
{
	int	oriIRKey;
	int	dstIRKey;
}stKIMURA_DTVKeymap;

int stKIMURA_Keymap[0x100] = {
...
/*0x18, 0x19 ,0x1a, 0x1b*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_SOURCE_ATV,
#if defined(ENABLE_TTX_SUBPAGE_BEHAVIOR_2)

#if defined(SIMPLE_RECORD)
/*0x1c, 0x1d ,0x1e, 0x1f*/	CMD_NOP, CMD_SOURCE_AV, CMD_NOP, CMD_NOP,
#else
...
#if defined(SIMPLE_RECORD)
/*0x44, 0x45 ,0x46, 0x47*/	CMD_PC_AUTO_ADJUST, CMD_NOP, CMD_NOP, CMD_NOP,
#else
...
/*0x80, 0x81 ,0x82, 0x83*/	CMD_CHANNEL_INC, CMD_NOP, CMD_DISPLAY_RATIO, CMD_VOL_UP,
/*0x84, 0x85 ,0x86, 0x87*/	CMD_NOP, CMD_NOP, CMD_VOL_DOWN, CMD_OPTION_RED,
/*0x88, 0x89 ,0x8a, 0x8b*/	CMD_NOP, CMD_USB, CMD_SLEEP, CMD_OPTION_GREEN,
/*0x8c, 0x8d ,0x8e, 0x8f*/	CMD_NOP, CMD_NOP, CMD_CHANNEL_DEC, CMD_OPTION_YELLOW,

/*0x90, 0x91 ,0x92, 0x93*/	CMD_NOP, CMD_NOP, CMD_UP, CMD_OPTION_GREEN,
/*0x94, 0x95 ,0x96, 0x97*/	CMD_NOP, CMD_ONE, CMD_SEVEN, CMD_LEFT,
/*0x98, 0x99 ,0x9a, 0x9b*/	CMD_NOP, CMD_TWO, CMD_EIGHT, CMD_ENTER,
/*0x9c, 0x9d ,0x9e, 0x9f*/	CMD_NOP, CMD_THREE, CMD_NINE, CMD_RIGHT,
...
/*0xc0, 0xc1 ,0xc2, 0xc3*/	CMD_FAVCH_DOWN, CMD_AUDIO, CMD_NOP, CMD_MENU,
/*0xc4, 0xc5 ,0xc6, 0xc7*/	CMD_NOP, CMD_NOP, CMD_FFWD, CMD_TELETEXT,
/*0xc8, 0xc9 ,0xca, 0xcb*/	CMD_GOTO, CMD_STOP, CMD_PREV, CMD_FRWD,
/*0xcc, 0xcd ,0xce, 0xcf*/	CMD_TELETEXT_SUBTITLE, CMD_FAVCH_UP, CMD_PICTURE_MODE, CMD_FAVCH,

/*0xd0, 0xd1 ,0xd2, 0xd3*/	CMD_NOP, CMD_SOUND_MODE, CMD_AB_REPEAT, CMD_DTV_RDO_JUMP,
/*0xd4, 0xd5 ,0xd6, 0xd7*/	CMD_DISPLAY, CMD_DASH, CMD_FOUR, CMD_POWER,
/*0xd8, 0xd9 ,0xda, 0xdb*/	CMD_DOWN, CMD_ZERO, CMD_FIVE, CMD_NOP,
/*0xdc, 0xdd ,0xde, 0xdf*/	CMD_SOURCE, CMD_JUMP, CMD_SIX, CMD_MUTE,
...
stKIMURA_DTVKeymap		TVKeyMapTab_KIMURA[]=
{
	{CMD_TELETEXT_SUBTITLE,		CMD_STITLE},
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--start
stKIMURA_DTVKeymap		DTVKeyMapTab_KIMURA[]=
{
    {CMD_GOTO,                  CMD_EPG},
    {CMD_AB_REPEAT,             CMD_PVR_TIMESHIFT},
    {CMD_PC_AUTO_ADJUST,        CMD_PVR_RECORD},
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--end
stKIMURA_DTVKeymap		AVKeyMapTab_KIMURA[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stKIMURA_DTVKeymap		PCKeyMapTab_KIMURA[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stKIMURA_DTVKeymap		HDMIKeyMapTab_KIMURA[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stKIMURA_DTVKeymap		MEDIAKeyMapTab_KIMURA[]=
{
	{CMD_MENU, 					CMD_QUICK},
	{CMD_EXIT,					CMD_RETURN},
	{CMD_TELETEXT,				CMD_PLAY_PAUSE},
	{CMD_DTV_RDO_JUMP,			CMD_REPEAT},
	// {CMD_OPTION_BLUE,			CMD_AB_REPEAT},
	{CMD_NOP,					CMD_NOP},
};
stKIMURA_DTVKeymap		DVDKeyMapTab_KIMURA[]=
{	// IR_CMD				DVD_CODE
	{CMD_MUTE,					0x003C},
	{CMD_NOP,					CMD_NOP},
};
stKIMURA_DTVKeymap		DefaultKeyMapTab_KIMURA[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};	

stKIMURA_DTVKeymap		TTKeyMapTab_KIMURA[]=
{
	// {CMD_FAVCH,					CMD_TT_MIX},
	{CMD_STOP, 				CMD_TT_HOLD},
	{CMD_FFWD, 			CMD_TT_REVEAL},
    {CMD_FRWD,          CMD_OPTION_SUBPAGE},
	{CMD_PREV,					CMD_TT_INDEX},
	{CMD_NEXT,			CMD_WIDE},
...
stKIMURA_DTVKeymap		RECKeyMapTab_KIMURA[]=
{
    {CMD_TELETEXT,				CMD_PLAY_PAUSE},
	{CMD_NOP,					CMD_NOP},
};
...
static stKIMURA_DTVKeymap DVDKeyMapTab[]=
{
...
/*************************************************************************************************************************************/
extern stKIMURA_DTVKeymap DVD_key[4];
extern unsigned int custome_code;
stKIMURA_DTVKeymap *pDVD_key = ( stKIMURA_DTVKeymap *)DVDKeyMapTab;
...
int remote_KIMURA_nec(int code)
{
	stKIMURA_DTVKeymap* pKeymap=NULL;
	int   cDscIrKey=0;
	int   cDscIrSWKey=0;
	int i =0;
	...
	if((code & 0x0000ffff) != KIMURA_CUSTOMER)
	    return -1;
	...
	switch (source)
	{
			...
			//add by lq@2014.12.16--start
			{
				if(TvApi_GetIDtvSubSource() >= 1)
				{
					if( TvApi_IsRecording() == true )
						pKeymap=RECKeyMapTab_KIMURA;
					else
						pKeymap=DTVKeyMapTab_KIMURA;
				}
				else
				{
					if( TvApi_IsRecording() == true )
		...
		case SOURCE_HDMI3:
			pKeymap=HDMIKeyMapTab_KIMURA;
			break;
		
		case SOURCE_BROWSER:
		case SOURCE_OSD:
		case SOURCE_PLAYBACK://add by zjl@2014.06.11
			pKeymap=MEDIAKeyMapTab_KIMURA;
			break;
...
#endif
		default:
			pKeymap=DefaultKeyMapTab_KIMURA;
			break;
