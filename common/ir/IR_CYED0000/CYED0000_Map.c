...
#include "CYED0000_Map.h"

typedef	struct _stCYED0000_DTVKeyMAP
{

	int	oriIRKey;
	int	dstIRKey;
}stCYED0000_DTVKeymap;


int stCYED0000_Keymap[0x100] = {
...
/*0x44, 0x45 ,0x46, 0x47*/	CMD_USB, CMD_PC_AUTO_ADJUST, CMD_NOP, CMD_NOP,
...
/*0xe0, 0xe1 ,0xe2, 0xe3*/	CMD_PVR_RECORD, CMD_NOP, CMD_TELETEXT_SUBTITLE, CMD_NOP,
...
stCYED0000_DTVKeymap	TVKeyMapTab_CYED0000[]=
{
	{CMD_PREV,					CMD_TT_MIX},
...
stCYED0000_DTVKeymap	DTVKeyMapTab_CYED0000[]=
{
	{CMD_PREV,					CMD_TT_MIX},
	{CMD_NEXT,					CMD_TT_REVEAL},	
	{CMD_FFWD, 					CMD_TT_HOLD},
...
stCYED0000_DTVKeymap	AVKeyMapTab_CYED0000[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stCYED0000_DTVKeymap	PCKeyMapTab_CYED0000[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stCYED0000_DTVKeymap	HDMIKeyMapTab_CYED0000[]=
{
	{CMD_EPG,				CMD_STOP},
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
...
stCYED0000_DTVKeymap MEDIAKeyMapTab_CYED0000[] =
{
	{CMD_EPG,					CMD_NOP},
	{CMD_FREEZE,				CMD_NOP},
	{CMD_MENU,					CMD_QUICK},
...
stCYED0000_DTVKeymap	TTKeyMapTab_CYED0000[]=
{	
	{CMD_PREV,					CMD_TT_MIX},
	{CMD_NEXT,					CMD_TT_REVEAL},	
	{CMD_FFWD, 					CMD_TT_HOLD},
...
stCYED0000_DTVKeymap DefaultKeyMapTab_CYED0000[] ={

	{CMD_NOP,					CMD_NOP},

};
stCYED0000_DTVKeymap DVDKeyMapTab_CYED0000[] ={

	{CMD_NOP,					CMD_NOP},
};
stCYED0000_DTVKeymap RECKeyMapTab_CYED0000[] = {
...
static stCYED0000_DTVKeymap DVDKeyMapTab[]=
{
	/*
...
extern stCYED0000_DTVKeymap DVD_key[4];
extern unsigned int custome_code;
stCYED0000_DTVKeymap *pDVD_key = ( stCYED0000_DTVKeymap *)DVDKeyMapTab;
...
int remote_CYED0000_nec(int code)
{
	stCYED0000_DTVKeymap* pKeymap=NULL;
	int   cDscIrKey=0;
	int   cDscIrSWKey=0;
	int i =0;
	...
	if((code & 0x0000ffff) != CYED0000_CUSTOMER)
	    return -1;
	...
	switch (source)
	{
		case SOURCE_IDTV1:
			...
			if(HK_GetTT_Enable())
				pKeymap=TTKeyMapTab_CYED0000;
			else	
			{
				if(TvApi_GetIDtvSubSource() >= 1)
				{
					if( TvApi_IsRecording() == true )
						pKeymap=RECKeyMapTab_CYED0000;
					else
						pKeymap=DTVKeyMapTab_CYED0000;
				}
				else
				{
					if( TvApi_IsRecording() == true )
		...
		case SOURCE_HDMI3:
			pKeymap=HDMIKeyMapTab_CYED0000;
			break;
		
		case SOURCE_BROWSER:
		case SOURCE_OSD:
		case SOURCE_PLAYBACK:
			pKeymap=MEDIAKeyMapTab_CYED0000;
			break;
		
#if defined(ENABLE_DVD_SOURCE)
		case SOURCE_YPP2:
			pKeymap=DVDKeyMapTab_CYED0000;
			break;
#endif
		default:
			pKeymap=DefaultKeyMapTab_CYED0000;
			break;
