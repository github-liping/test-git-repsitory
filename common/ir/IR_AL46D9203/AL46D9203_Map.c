...
#include "AL46D9203_Map.h"

typedef	struct _stAL46D9203_DTVKeyMAP
{
	int	oriIRKey;
	int	dstIRKey;
}stAL46D9203_DTVKeymap;

int stAL46D9203_Keymap[0x100] = {
...
/*0x50, 0x51 ,0x52, 0x53*/	CMD_TT_TXCL, CMD_TELETEXT_SUBTITLE, CMD_TELETEXT, CMD_FREEZE,
...
stAL46D9203_DTVKeymap		TVKeyMapTab_AL46D9203[]=
{
...
stAL46D9203_DTVKeymap		DTVKeyMapTab_AL46D9203[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--end
stAL46D9203_DTVKeymap		AVKeyMapTab_AL46D9203[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stAL46D9203_DTVKeymap		PCKeyMapTab_AL46D9203[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stAL46D9203_DTVKeymap		HDMIKeyMapTab_AL46D9203[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stAL46D9203_DTVKeymap		MEDIAKeyMapTab_AL46D9203[]=
{
	...
	{CMD_FREEZE,				CMD_STOP},
	{CMD_TT_TXCL,				CMD_REPEAT},
	{CMD_NOP,					CMD_NOP},
};
stAL46D9203_DTVKeymap		DVDKeyMapTab_AL46D9203[]=
{	// IR_CMD				DVD_CODE
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stAL46D9203_DTVKeymap		DefaultKeyMapTab_AL46D9203[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};	

stAL46D9203_DTVKeymap		TTKeyMapTab_AL46D9203[]=
{
...
stAL46D9203_DTVKeymap		RECKeyMapTab_AL46D9203[]=
{
	{CMD_OPTION_RED,			CMD_FRWD},
	{CMD_OPTION_GREEN,			CMD_FFWD},
	{CMD_OPTION_YELLOW,			CMD_PREV},
...
static stAL46D9203_DTVKeymap DVDKeyMapTab[]=
{
...
/*************************************************************************************************************************************/
extern stAL46D9203_DTVKeymap DVD_key[4];
extern unsigned int custome_code;
stAL46D9203_DTVKeymap *pDVD_key = ( stAL46D9203_DTVKeymap *)DVDKeyMapTab;
...
int remote_AL46D9203_nec(int code)
{
	stAL46D9203_DTVKeymap* pKeymap=NULL;
	int   cDscIrKey=0;
	int   cDscIrSWKey=0;
	int i =0;
	...
	if((code & 0x0000ffff) != AL46D9203_CUSTOMER)
	    return -1;
	...
	while(i <=0xFF) //modify by zjl@2014.10.22
	{
		...
		{
			cDscIrKey=stAL46D9203_Keymap[i];
			break;
		}
		i++;
	}
	...
	switch (source)
	{
			...
			//add by lq@2014.12.16--start
			{
				if(TvApi_GetIDtvSubSource() >= 1)
				{
					...
					if( TvApi_IsRecording() == true )
						pKeymap=RECKeyMapTab_AL46D9203;
					else
					#endif
						pKeymap=DTVKeyMapTab_AL46D9203;
				}
				else
				{
					#ifndef BUILD_TV036_2_ISDB	
		...
		case SOURCE_HDMI3:
			pKeymap=HDMIKeyMapTab_AL46D9203;
			break;
		
		case SOURCE_BROWSER:
		case SOURCE_OSD:
		case SOURCE_PLAYBACK://add by zjl@2014.06.11
			pKeymap=MEDIAKeyMapTab_AL46D9203;
			break;
...
#endif
		default:
			pKeymap=DefaultKeyMapTab_AL46D9203;
			break;
