...
#include "CN22601_Map.h"

typedef	struct _stCN22601_DTVKeyMAP
{
	int	oriIRKey;
	int	dstIRKey;
}stCN22601_DTVKeymap;

int stCN22601_Keymap[0x100] = {
/*0x00, 0x01 ,0x02, 0x03*/	CMD_ZERO, CMD_ONE, CMD_TWO, CMD_THREE,
/*0x04, 0x05 ,0x06, 0x07*/	CMD_FOUR, CMD_FIVE, CMD_SIX, CMD_SEVEN,
/*0x08, 0x09 ,0x0a, 0x0b*/	CMD_EIGHT, CMD_NINE, CMD_NOP, CMD_NOP,
/*0x0c, 0x0d ,0x0e, 0x0f*/	CMD_NOP, CMD_POWER, CMD_DISPLAY, CMD_TELETEXT,

/*0x10, 0x11 ,0x12, 0x13*/	CMD_SOUND_MODE, CMD_PICTURE_MODE, CMD_MUTE, CMD_SLEEP,
/*0x14, 0x15 ,0x16, 0x17*/	CMD_MENU, CMD_ENTER, CMD_UP, CMD_DOWN,
/*0x18, 0x19 ,0x1a, 0x1b*/	CMD_RIGHT, CMD_LEFT, CMD_PLAY_PAUSE, CMD_NOP,
/*0x1c, 0x1d ,0x1e, 0x1f*/	CMD_SOURCE, CMD_NOP, CMD_EPG, CMD_USB,
...
/*0x40, 0x41 ,0x42, 0x43*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_CHANNEL_DEC,
/*0x44, 0x45 ,0x46, 0x47*/	CMD_CHANNEL_INC, CMD_NOP, CMD_NOP, CMD_NOP,
/*0x48, 0x49 ,0x4a, 0x4b*/	CMD_FRWD, CMD_STOP, CMD_VOL_UP, CMD_VOL_DOWN,
/*0x4c, 0x4d ,0x4e, 0x4f*/	CMD_PREV, CMD_DTV_RDO_JUMP, CMD_NOP,CMD_DISPLAY_RATIO,

/*0x50, 0x51 ,0x52, 0x53*/	CMD_NOP, CMD_NOP, CMD_OPTION_RED, CMD_OPTION_GREEN,
/*0x54, 0x55 ,0x56, 0x57*/	CMD_OPTION_YELLOW, CMD_OPTION_BLUE, CMD_NOP, CMD_FAVCH_DOWN,
/*0x58, 0x59 ,0x5a, 0x5b*/	CMD_DASH, CMD_TELETEXT_SUBTITLE, CMD_FAVCH, CMD_NOP,
/*0x5c, 0x5d ,0x5e, 0x5f*/	CMD_EXIT, CMD_NEXT, CMD_FAVCH_UP, CMD_NOP,
...
stCN22601_DTVKeymap		TVKeyMapTab_CN22601[]=
{
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--start
stCN22601_DTVKeymap		DTVKeyMapTab_CN22601[]=
{
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--end
stCN22601_DTVKeymap		AVKeyMapTab_CN22601[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stCN22601_DTVKeymap		PCKeyMapTab_CN22601[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stCN22601_DTVKeymap		HDMIKeyMapTab_CN22601[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stCN22601_DTVKeymap		MEDIAKeyMapTab_CN22601[]=
{
	{CMD_NOP,					CMD_NOP},
};
stCN22601_DTVKeymap		DVDKeyMapTab_CN22601[]=
{	// IR_CMD				DVD_CODE
	{CMD_MUTE,					0x003C},
	{CMD_NOP,					CMD_NOP},
};
stCN22601_DTVKeymap		DefaultKeyMapTab_CN22601[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};	

stCN22601_DTVKeymap		TTKeyMapTab_CN22601[]=
{
...
stCN22601_DTVKeymap		RECKeyMapTab_CN22601[]=
{
	{CMD_NOP,					CMD_NOP},
};
...
static stCN22601_DTVKeymap DVDKeyMapTab[]=
{
...
/*************************************************************************************************************************************/
extern stCN22601_DTVKeymap DVD_key[4];
extern unsigned int custome_code;
stCN22601_DTVKeymap *pDVD_key = ( stCN22601_DTVKeymap *)DVDKeyMapTab;
...
int remote_CN22601_nec(int code)
{
	stCN22601_DTVKeymap* pKeymap=NULL;
	int   cDscIrKey=0;
	int   cDscIrSWKey=0;
	int i =0;
	...
	if((code & 0x0000ffff) != CN22601_CUSTOMER)
	    return -1;
	...
	switch (source)
	{
			...
			//add by lq@2014.12.16--start
			{
				if(TvApi_GetIDtvSubSource() >= 1)
				{
					if( TvApi_IsRecording() == true )
						pKeymap=RECKeyMapTab_CN22601;
					else
						pKeymap=DTVKeyMapTab_CN22601;
				}
				else
				{
					if( TvApi_IsRecording() == true )
		...
		case SOURCE_HDMI3:
			pKeymap=HDMIKeyMapTab_CN22601;
			break;
		
		case SOURCE_BROWSER:
		case SOURCE_OSD:
		case SOURCE_PLAYBACK://add by zjl@2014.06.11
			pKeymap=MEDIAKeyMapTab_CN22601;
			break;
...
#endif
		default:
			pKeymap=DefaultKeyMapTab_CN22601;
			break;
