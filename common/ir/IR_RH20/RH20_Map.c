...
typedef	struct _stRH20_DTVKeyMAP
{
	int	oriIRKey;
	int	dstIRKey;
}stRH20_DTVKeymap;

int stRH20_Keymap[0x100] = {
/*0x00, 0x01 ,0x02, 0x03*/	CMD_POWER, CMD_MUTE, CMD_ONE, CMD_TWO,
/*0x04, 0x05 ,0x06, 0x07*/	CMD_THREE, CMD_FOUR, CMD_FIVE, CMD_SIX,
/*0x08, 0x09 ,0x0a, 0x0b*/	CMD_SEVEN, CMD_EIGHT, CMD_NINE, CMD_DASH,
...
stRH20_DTVKeymap		TVKeyMapTab_RH20[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--start
stRH20_DTVKeymap		DTVKeyMapTab_RH20[]=
{
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--end
stRH20_DTVKeymap		AVKeyMapTab_RH20[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stRH20_DTVKeymap		PCKeyMapTab_RH20[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stRH20_DTVKeymap		HDMIKeyMapTab_RH20[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stRH20_DTVKeymap		MEDIAKeyMapTab_RH20[]=
{
	{CMD_MENU, 					CMD_QUICK},
	{CMD_EXIT,					CMD_RETURN},
	{CMD_TT_TXCL,				CMD_NOP},
...
stRH20_DTVKeymap		DVDKeyMapTab_RH20[]=
{	// IR_CMD				DVD_CODE
	//{CMD_MUTE,				0x003C},
	{CMD_NOP,					CMD_NOP},
};
stRH20_DTVKeymap		DefaultKeyMapTab_RH20[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};	

stRH20_DTVKeymap		TTKeyMapTab_RH20[]=
{
...
static stRH20_DTVKeymap DVDKeyMapTab[]=
{
	{CMD_ZERO,						0x0e},//4
	{CMD_ONE,						0x0d},//4
	{CMD_TWO,						0x19},//4
...
int remote_RH20_nec(int code)
{
	stRH20_DTVKeymap* pKeymap=NULL;
	int   cDscIrKey=0;
	int   cDscIrSWKey=0;
	int i =0;
	...
	if((code & 0x0000ffff) != RH20_CUSTOMER)
	    return -1;
	...
	switch (source)
	{
		case SOURCE_IDTV1:
			...
			if(HK_GetTT_Enable())
				pKeymap=TTKeyMapTab_RH20;
			else
			//modify by zjl@2014.09.01--start	
			{
				if(TvApi_GetIDtvSubSource() >= 1)
					pKeymap=DTVKeyMapTab_RH20;
				else
					pKeymap=TVKeyMapTab_RH20;
			}
		...
		case SOURCE_HDMI3:
			pKeymap=HDMIKeyMapTab_RH20;
			break;
		
		case SOURCE_BROWSER:
		case SOURCE_OSD:
		case SOURCE_PLAYBACK://add by zjl@2014.06.11
			pKeymap=MEDIAKeyMapTab_RH20;
			break;
