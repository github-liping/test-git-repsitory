...
#include "KXD6122_Map.h"

typedef	struct _stKXD6122_DTVKeyMAP
{
	int	oriIRKey;
	int	dstIRKey;
}stKXD6122_DTVKeymap;

int stKXD6122_Keymap[0x100] = {
/*0x00, 0x01 ,0x02, 0x03*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_NOP,
/*0x04, 0x05 ,0x06, 0x07*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_LIST,
/*0x08, 0x09 ,0x0a, 0x0b*/	CMD_NOP, CMD_POWER, CMD_NOP, CMD_NOP,
/*0x0c, 0x0d ,0x0e, 0x0f*/	CMD_LEFT, CMD_SOURCE, CMD_DISPLAY, CMD_NOP,

/*0x10, 0x11 ,0x12, 0x13*/	CMD_PLAY, CMD_NOP, CMD_RETURN, CMD_NOP,
/*0x14, 0x15 ,0x16, 0x17*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_STOP,
/*0x18, 0x19 ,0x1a, 0x1b*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_DOWN,
#if defined(ENABLE_TTX_SUBPAGE_BEHAVIOR_2)

#if defined(SIMPLE_RECORD)
/*0x1c, 0x1d ,0x1e, 0x1f*/	CMD_NOP, CMD_MENU, CMD_TELETEXT, CMD_NOP,
#else
/*0x1c, 0x1d ,0x1e, 0x1f*/	CMD_NOP, CMD_MENU, CMD_TELETEXT, CMD_NOP,
#endif
#endif
...
#if defined(SIMPLE_RECORD)
/*0x44, 0x45 ,0x46, 0x47*/	CMD_NOP, CMD_UP, CMD_ENTER, CMD_NOP,
#else
/*0x44, 0x45 ,0x46, 0x47*/	CMD_NOP, CMD_UP, CMD_ENTER, CMD_NOP,
#endif
...
/*0x50, 0x51 ,0x52, 0x53*/	CMD_NOP, CMD_MUTE, CMD_RIGHT, CMD_NOP,
/*0x54, 0x55 ,0x56, 0x57*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_NOP,
/*0x58, 0x59 ,0x5a, 0x5b*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_NOP,
/*0x5c, 0x5d ,0x5e, 0x5f*/	CMD_NOP, CMD_JUMP, CMD_NOP, CMD_NOP,
...
stKXD6122_DTVKeymap		TVKeyMapTab_KXD6122[]=
{
	{CMD_TELETEXT_SUBTITLE,		CMD_STITLE},
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--start
stKXD6122_DTVKeymap		DTVKeyMapTab_KXD6122[]=
{
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--end
stKXD6122_DTVKeymap		AVKeyMapTab_KXD6122[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stKXD6122_DTVKeymap		PCKeyMapTab_KXD6122[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stKXD6122_DTVKeymap		HDMIKeyMapTab_KXD6122[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stKXD6122_DTVKeymap		MEDIAKeyMapTab_KXD6122[]=
{
	{CMD_MENU, 					CMD_QUICK},
	{CMD_EXIT,					CMD_RETURN},
	{CMD_TT_TXCL,				CMD_NOP},
...
stKXD6122_DTVKeymap		DVDKeyMapTab_KXD6122[]=
{	// IR_CMD				DVD_CODE
	{CMD_MUTE,					0x003C},
	{CMD_NOP,					CMD_NOP},
};
stKXD6122_DTVKeymap		DefaultKeyMapTab_KXD6122[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};	

stKXD6122_DTVKeymap		TTKeyMapTab_KXD6122[]=
{
...
stKXD6122_DTVKeymap		RECKeyMapTab_KXD6122[]=
{
	{CMD_NOP,					CMD_NOP},
};
...
static stKXD6122_DTVKeymap DVDKeyMapTab[]=
{
...
/*************************************************************************************************************************************/
extern stKXD6122_DTVKeymap DVD_key[4];
extern unsigned int custome_code;
stKXD6122_DTVKeymap *pDVD_key = ( stKXD6122_DTVKeymap *)DVDKeyMapTab;
...
int remote_KXD6122_nec(int code)
{
	stKXD6122_DTVKeymap* pKeymap=NULL;
	int   cDscIrKey=0;
	int   cDscIrSWKey=0;
	int i =0;
	...
	if((code & 0x0000ffff) != KXD6122_CUSTOMER)
	    return -1;
	...
	switch (source)
	{
			...
			//add by lq@2014.12.16--start
			{
				if(TvApi_GetIDtvSubSource() >= 1)
				{
					if( TvApi_IsRecording() == true )
						pKeymap=RECKeyMapTab_KXD6122;
					else
						pKeymap=DTVKeyMapTab_KXD6122;
				}
				else
				{
					if( TvApi_IsRecording() == true )
		...
		case SOURCE_HDMI3:
			pKeymap=HDMIKeyMapTab_KXD6122;
			break;
		
		case SOURCE_BROWSER:
		case SOURCE_OSD:
		case SOURCE_PLAYBACK://add by zjl@2014.06.11
			pKeymap=MEDIAKeyMapTab_KXD6122;
			break;
...
#endif
		default:
			pKeymap=DefaultKeyMapTab_KXD6122;
			break;
