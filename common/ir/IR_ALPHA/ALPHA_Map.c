...
typedef	struct _stALPHA_DTVKeyMAP
{
	int	oriIRKey;
	int	dstIRKey;
}stALPHA_DTVKeymap;

int stALPHA_Keymap[0x100] = {
...
/*0x80, 0x81 ,0x82, 0x83*/	CMD_CHANNEL_INC, CMD_AUDIO, CMD_DISPLAY_RATIO, CMD_VOL_UP,
/*0x84, 0x85 ,0x86, 0x87*/	CMD_NOP, CMD_OPTION_RED, CMD_VOL_DOWN, CMD_PVR_RECORD,
/*0x88, 0x89 ,0x8a, 0x8b*/	CMD_NOP, CMD_OPTION_GREEN, CMD_DISPLAY, CMD_STOP,
/*0x8c, 0x8d ,0x8e, 0x8f*/	CMD_NOP, CMD_OPTION_YELLOW, CMD_CHANNEL_DEC, CMD_PREV,

/*0x90, 0x91 ,0x92, 0x93*/	CMD_NOP, CMD_OPTION_BLUE, CMD_UP, CMD_NEXT,
...
/*0xc4, 0xc5 ,0xc6, 0xc7*/	CMD_EPG, CMD_NOP, CMD_NOP, CMD_FAVCH,
/*0xc8, 0xc9 ,0xca, 0xcb*/	CMD_TELETEXT_SUBTITLE, CMD_NOP, CMD_TT_HOLD, CMD_TELETEXT,
/*0xcc, 0xcd ,0xce, 0xcf*/	CMD_OPTION_SUBPAGE, CMD_TT_REVEAL, CMD_WIDE, CMD_TT_INDEX,

/*0xd0, 0xd1 ,0xd2, 0xd3*/	CMD_FFWD, CMD_FRWD, CMD_PLAY_PAUSE, CMD_NOP,
...
stALPHA_DTVKeymap		TVKeyMapTab_ALPHA[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--start
stALPHA_DTVKeymap		DTVKeyMapTab_ALPHA[]=
{
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--end
stALPHA_DTVKeymap		AVKeyMapTab_ALPHA[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stALPHA_DTVKeymap		PCKeyMapTab_ALPHA[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stALPHA_DTVKeymap		HDMIKeyMapTab_ALPHA[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stALPHA_DTVKeymap		MEDIAKeyMapTab_ALPHA[]=
{
	{CMD_EXIT,					CMD_RETURN},
	{CMD_NOP,					CMD_NOP},
};
stALPHA_DTVKeymap		DVDKeyMapTab_ALPHA[]=
{	// IR_CMD				DVD_CODE
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stALPHA_DTVKeymap		DefaultKeyMapTab_ALPHA[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};	

stALPHA_DTVKeymap		TTKeyMapTab_ALPHA[]=
{
...
stALPHA_DTVKeymap		RECKeyMapTab_ALPHA[]=
{
...
static stALPHA_DTVKeymap DVDKeyMapTab[]=
{
...
/*************************************************************************************************************************************/
extern stALPHA_DTVKeymap DVD_key[4];
extern unsigned int custome_code;
stALPHA_DTVKeymap *pDVD_key = ( stALPHA_DTVKeymap *)DVDKeyMapTab;
...
int remote_ALPHA_nec(int code)
{
	stALPHA_DTVKeymap* pKeymap=NULL;
	...
	if((code & 0x0000ffff) != ALPHA_CUSTOMER)		//匹配客户码
	    return -1;
	...
	switch (source)								//选通道
	{
			...
			//add by lq@2014.12.16--start
			{
				if(TvApi_GetIDtvSubSource() >= 1)
				{
					if( TvApi_IsRecording() == true )	//REC_MODE?
						pKeymap=RECKeyMapTab_ALPHA;
					else
						pKeymap=DTVKeyMapTab_ALPHA;
				}
				else
				{
		...
		case SOURCE_HDMI3:
			pKeymap=HDMIKeyMapTab_ALPHA;
			break;
		
		case SOURCE_BROWSER:
		case SOURCE_OSD:
		case SOURCE_PLAYBACK://add by zjl@2014.06.11			//MEDIA_MODE?
			pKeymap=MEDIAKeyMapTab_ALPHA;
			break;
...
#endif
		default:
			pKeymap=DefaultKeyMapTab_ALPHA;
			break;
