...
typedef	struct _stHKC_DTVKeyMAP
{
	int	oriIRKey;
	int	dstIRKey;
}stHKC_DTVKeymap;

int stHKC_Keymap[0x100] = {
/*0x00, 0x01 ,0x02, 0x03*/	CMD_ONE, CMD_NOP, CMD_CHANNEL_INC, CMD_VOL_UP,
/*0x04, 0x05 ,0x06, 0x07*/	CMD_AUDIO, CMD_NOP, CMD_MENU, CMD_DISPLAY,
/*0x08, 0x09 ,0x0a, 0x0b*/	CMD_NOP, CMD_CHANNEL_INC, CMD_RETURN, CMD_AUDIO,
/*0x0c, 0x0d ,0x0e, 0x0f*/	CMD_NOP, CMD_PC_AUTO_ADJUST, CMD_NOP, CMD_TIMESHIFT,

/*0x10, 0x11 ,0x12, 0x13*/	CMD_TWO, CMD_THREE, CMD_FRWD, CMD_FOUR,
/*0x14, 0x15 ,0x16, 0x17*/	CMD_FIVE, CMD_SIX, CMD_NOP, CMD_SEVEN,
/*0x18, 0x19 ,0x1a, 0x1b*/	CMD_EIGHT, CMD_NINE, CMD_FAVCH, CMD_ZERO,
/*0x1c, 0x1d ,0x1e, 0x1f*/	CMD_DASH, CMD_PICTURE_MODE, CMD_NOP, CMD_SOUND_MODE,
...
/*0x40, 0x41 ,0x42, 0x43*/	CMD_SOURCE, CMD_VOL_DOWN, CMD_STITLE, CMD_TELETEXT_SUBTITLE,
/*0x44, 0x45 ,0x46, 0x47*/	CMD_PREV, CMD_PLAY_PAUSE, CMD_DISPLAY_RATIO, CMD_UP,
/*0x48, 0x49 ,0x4a, 0x4b*/	CMD_FREEZE, CMD_LEFT, CMD_ENTER, CMD_RIGHT,
/*0x4c, 0x4d ,0x4e, 0x4f*/	CMD_JUMP, CMD_DOWN, CMD_SLEEP, CMD_NOP,

/*0x50, 0x51 ,0x52, 0x53*/	CMD_NEXT, CMD_FFWD, CMD_POWER, CMD_MUTE,
/*0x54, 0x55 ,0x56, 0x57*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_EPG,
/*0x58, 0x59 ,0x5a, 0x5b*/	CMD_NOP, CMD_SOURCE_DTV, CMD_NOP, CMD_STOP,
...
stHKC_DTVKeymap		TVKeyMapTab_HKC[]=
{
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--start
stHKC_DTVKeymap		DTVKeyMapTab_HKC[]=
{
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--end
stHKC_DTVKeymap		AVKeyMapTab_HKC[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stHKC_DTVKeymap		PCKeyMapTab_HKC[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stHKC_DTVKeymap		HDMIKeyMapTab_HKC[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stHKC_DTVKeymap		MEDIAKeyMapTab_HKC[]=
{
	{CMD_NOP,					CMD_NOP},
};
stHKC_DTVKeymap		DVDKeyMapTab_HKC[]=
{	// IR_CMD				DVD_CODE
	{CMD_MUTE,					0x003C},
	{CMD_NOP,					CMD_NOP},
};
stHKC_DTVKeymap		DefaultKeyMapTab_HKC[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};	

stHKC_DTVKeymap		TTKeyMapTab_HKC[]=
{
	{CMD_NEXT,			CMD_TT_MIX},
...
stHKC_DTVKeymap		RECKeyMapTab_HKC[]=
{
	{CMD_NOP,					CMD_NOP},
};
...
static stHKC_DTVKeymap DVDKeyMapTab[]=
{
...
/*************************************************************************************************************************************/
extern stHKC_DTVKeymap DVD_key[4];
extern unsigned int custome_code;
stHKC_DTVKeymap *pDVD_key = ( stHKC_DTVKeymap *)DVDKeyMapTab;
...
int remote_HKC_nec(int code)
{
	stHKC_DTVKeymap* pKeymap=NULL;
	int   cDscIrKey=0;
	int   cDscIrSWKey=0;
	int i =0;
	...
	if((code & 0x0000ffff) != HKC_CUSTOMER)
	    return -1;
	...
	switch (source)
	{
			...
			//add by lq@2014.12.16--start
			{
				if(TvApi_GetIDtvSubSource() >= 1)
				{
					...
					if( TvApi_IsRecording() == true )
						pKeymap=RECKeyMapTab_HKC;
					else
					#endif
						pKeymap=DTVKeyMapTab_HKC;
				}
				else
				{
					#ifndef BUILD_TV036_2_ISDB	
		...
		case SOURCE_HDMI3:
			pKeymap=HDMIKeyMapTab_HKC;
			break;
		
		case SOURCE_BROWSER:
		case SOURCE_OSD:
		case SOURCE_PLAYBACK://add by zjl@2014.06.11
			pKeymap=MEDIAKeyMapTab_HKC;
			break;
...
/*0x40, 0x41 ,0x42, 0x43*/	CMD_FAVCH_DOWN, CMD_PLAY, CMD_NOP, CMD_EPG,
