...
typedef	struct _stTEAC_DTVKeyMAP
{
	int	oriIRKey;
	int	dstIRKey;
}stTEAC_DTVKeymap;

int stTEAC_Keymap[0x100] = {
...
stTEAC_DTVKeymap		TVKeyMapTab_TEAC[]=
{
...
stTEAC_DTVKeymap		DTVKeyMapTab_TEAC[]=
{
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--end
stTEAC_DTVKeymap		AVKeyMapTab_TEAC[]=
{
	{CMD_PVR_FILE_LIST,			CMD_OPTION_GREEN},
	{CMD_PVR_SCHEDULE_LIST,		CMD_OPTION_YELLOW},	
	{CMD_NOP,					CMD_NOP},
...
stTEAC_DTVKeymap		PCKeyMapTab_TEAC[]=
{
	{CMD_PVR_FILE_LIST,			CMD_OPTION_GREEN},
	{CMD_PVR_SCHEDULE_LIST,		CMD_OPTION_YELLOW},	
...
stTEAC_DTVKeymap		HDMIKeyMapTab_TEAC[]=
{
	{CMD_PVR_FILE_LIST,			CMD_OPTION_GREEN},
	{CMD_PVR_SCHEDULE_LIST,		CMD_OPTION_YELLOW},	
	{CMD_NOP,					CMD_NOP},
...
stTEAC_DTVKeymap		MEDIAKeyMapTab_TEAC[]=
{
...
stTEAC_DTVKeymap		DVDKeyMapTab_TEAC[]=
{	// IR_CMD				DVD_CODE
	{CMD_MUTE,					0x003C},
	{CMD_NOP,					CMD_NOP},
};
stTEAC_DTVKeymap		DefaultKeyMapTab_TEAC[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};	

stTEAC_DTVKeymap		TTKeyMapTab_TEAC[]=
{
	{CMD_PVR_FILE_LIST,			CMD_OPTION_GREEN},
	{CMD_PVR_SCHEDULE_LIST,		CMD_OPTION_YELLOW},	
...
stTEAC_DTVKeymap		RECKeyMapTab_TEAC[]=
{
...
stTEAC_DTVKeymap		ColorKeyReuseMapTab_TEAC[]=
{
	{CMD_PVR_FILE_LIST,			CMD_OPTION_GREEN},
	{CMD_PVR_SCHEDULE_LIST,		CMD_OPTION_YELLOW},	
	{CMD_NOP,					CMD_NOP},
...
stTEAC_DTVKeymap		ColorKeyATVReuseMapTab_TEAC[]=
{
	{CMD_PVR_FILE_LIST,			CMD_OPTION_GREEN},
	{CMD_PVR_SCHEDULE_LIST,		CMD_OPTION_YELLOW},	
	{CMD_NOP,					CMD_NOP},	
...
static stTEAC_DTVKeymap DVDKeyMapTab[]=
{
...
/*************************************************************************************************************************************/
extern stTEAC_DTVKeymap DVD_key[4];
extern unsigned int custome_code;
stTEAC_DTVKeymap *pDVD_key = ( stTEAC_DTVKeymap *)DVDKeyMapTab;
...
int remote_TEAC_nec(int code)
{
	stTEAC_DTVKeymap* pKeymap=NULL;
	int   cDscIrKey=0;
	int   cDscIrSWKey=0;
	int i =0;
	...
	if((code & 0x0000ffff) != TEAC_CUSTOMER)
	    return -1;
	...
	switch (source)
	{
			...
			//add by lq@2014.12.16--start
			{
				if(TvApi_GetIDtvSubSource() >= 1)
				{
					if( TvApi_IsRecording() == true )
						pKeymap=RECKeyMapTab_TEAC;
					else
						pKeymap=DTVKeyMapTab_TEAC;
				}
				else
				{
					if( TvApi_IsRecording() == true )
		...
		case SOURCE_HDMI3:
			pKeymap=HDMIKeyMapTab_TEAC;
			break;
		
		case SOURCE_BROWSER:
		case SOURCE_OSD:
		case SOURCE_PLAYBACK://add by zjl@2014.06.11
			pKeymap=MEDIAKeyMapTab_TEAC;
			break;
