...
typedef	struct _stAKIRA_DTVKeyMAP
{
	int	oriIRKey;
	int	dstIRKey;
}stAKIRA_DTVKeymap;

int stAKIRA_Keymap[0x100] = {
/*0x00, 0x01 ,0x02, 0x03*/	CMD_ZERO, CMD_ONE, CMD_TWO, CMD_THREE,
/*0x04, 0x05 ,0x06, 0x07*/	CMD_FOUR, CMD_FIVE, CMD_SIX, CMD_SEVEN,
/*0x08, 0x09 ,0x0a, 0x0b*/	CMD_EIGHT, CMD_NINE, CMD_LIST, CMD_NOP,
/*0x0c, 0x0d ,0x0e, 0x0f*/	CMD_CHANNEL_INC, CMD_CHANNEL_DEC, CMD_VOL_UP, CMD_VOL_DOWN,

/*0x10, 0x11 ,0x12, 0x13*/	CMD_POWER, CMD_MUTE, CMD_SOURCE, CMD_DISPLAY,
/*0x14, 0x15 ,0x16, 0x17*/	CMD_NOP, CMD_MENU, CMD_EXIT, CMD_SLEEP,
/*0x18, 0x19 ,0x1a, 0x1b*/	CMD_NOP, CMD_UP, CMD_DOWN, CMD_LEFT,
/*0x1c, 0x1d ,0x1e, 0x1f*/	CMD_RIGHT, CMD_ENTER, CMD_FRWD, CMD_PLAY_PAUSE,
...
/*0x40, 0x41 ,0x42, 0x43*/	CMD_NOP, CMD_NOP, CMD_DISPLAY_RATIO, CMD_NOP,
/*0x44, 0x45 ,0x46, 0x47*/	CMD_NOP, CMD_NOP, CMD_NEXT, CMD_NOP,
/*0x48, 0x49 ,0x4a, 0x4b*/	CMD_NOP, CMD_FFWD, CMD_NOP, CMD_TELETEXT_SUBTITLE,
/*0x4c, 0x4d ,0x4e, 0x4f*/	CMD_PVR_FILE_LIST, CMD_NOP, CMD_PREV, CMD_NOP,

/*0x50, 0x51 ,0x52, 0x53*/	CMD_NOP, CMD_NOP, CMD_STOP, CMD_PVR_RECORD,
/*0x54, 0x55 ,0x56, 0x57*/	CMD_OPTION_RED, CMD_OPTION_BLUE, CMD_PVR_SCHEDULE_LIST, CMD_TELETEXT,
/*0x58, 0x59 ,0x5a, 0x5b*/	CMD_AB_REPEAT, CMD_TT_HOLD, CMD_AUDIO, CMD_JUMP,
...
stAKIRA_DTVKeymap		TVKeyMapTab_AKIRA[]=
{
...
stAKIRA_DTVKeymap		DTVKeyMapTab_AKIRA[]=
{
	
	{CMD_NEXT,					CMD_FAVCH},
	{CMD_PREV,					CMD_EPG},
	{CMD_FFWD,					CMD_DTV_RDO_JUMP},
	//{CMD_OPTION_GREEN,			CMD_PVR_FILE_LIST},
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--end
stAKIRA_DTVKeymap		AVKeyMapTab_AKIRA[]=
{
	{CMD_PVR_FILE_LIST,			CMD_OPTION_GREEN},
	{CMD_PVR_SCHEDULE_LIST,		CMD_OPTION_YELLOW},
	{CMD_NOP,					CMD_NOP},
};
stAKIRA_DTVKeymap		PCKeyMapTab_AKIRA[]=
{
	{CMD_PVR_FILE_LIST,			CMD_OPTION_GREEN},
	{CMD_PVR_SCHEDULE_LIST,		CMD_OPTION_YELLOW},
	{CMD_NOP,					CMD_NOP},
};
stAKIRA_DTVKeymap		HDMIKeyMapTab_AKIRA[]=
{
	{CMD_PVR_FILE_LIST,			CMD_OPTION_GREEN},
	{CMD_PVR_SCHEDULE_LIST,		CMD_OPTION_YELLOW},
	{CMD_NOP,					CMD_NOP},
};
stAKIRA_DTVKeymap		MEDIAKeyMapTab_AKIRA[]=
{
	{CMD_PVR_FILE_LIST,			CMD_OPTION_GREEN},
	{CMD_PVR_SCHEDULE_LIST,		CMD_OPTION_YELLOW},
	{CMD_TT_HOLD,				CMD_OPTION_GREEN},
	{CMD_PVR_RECORD,			CMD_REPEAT},
	{CMD_EXIT,					CMD_RETURN},
	{CMD_NOP,					CMD_NOP},
};
stAKIRA_DTVKeymap		DVDKeyMapTab_AKIRA[]=
{	// IR_CMD				DVD_CODE
	
	{CMD_NOP,					CMD_NOP},
};
stAKIRA_DTVKeymap		DefaultKeyMapTab_AKIRA[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};	

stAKIRA_DTVKeymap		TTKeyMapTab_AKIRA[]=
{
	{CMD_PVR_SCHEDULE_LIST,		CMD_OPTION_YELLOW},
	{CMD_PVR_FILE_LIST,	CMD_OPTION_GREEN},
	{CMD_AB_REPEAT,					CMD_TT_INDEX},
	{CMD_STOP,					CMD_TT_REVEAL},
	{CMD_PLAY_PAUSE,			CMD_WIDE},
	{CMD_FRWD,					CMD_OPTION_SUBPAGE},
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};

//add by lq@2014.12.16--start
stAKIRA_DTVKeymap		RECKeyMapTab_AKIRA[]=
{
...
static stAKIRA_DTVKeymap DVDKeyMapTab[]=
{
...
/*************************************************************************************************************************************/
extern stAKIRA_DTVKeymap DVD_key[4];
extern unsigned int custome_code;
stAKIRA_DTVKeymap *pDVD_key = ( stAKIRA_DTVKeymap *)DVDKeyMapTab;
...
int remote_AKIRA_nec(int code)
{
	stAKIRA_DTVKeymap* pKeymap=NULL;
	...
	if((code & 0x0000ffff) != AKIRA_CUSTOMER)		//匹配客户码
	    return -1;
	...
	switch (source)								//选通道
	{
			...
			//add by lq@2014.12.16--start
			{
				if(TvApi_GetIDtvSubSource() >= 1)
				{
					if( TvApi_IsRecording() == true )	//REC_MODE?
						pKeymap=RECKeyMapTab_AKIRA;
					else
						pKeymap=DTVKeyMapTab_AKIRA;
				}
				else
				{
		...
		case SOURCE_HDMI3:
			pKeymap=HDMIKeyMapTab_AKIRA;
			break;
		
		case SOURCE_BROWSER:
		case SOURCE_OSD:
		case SOURCE_PLAYBACK://add by zjl@2014.06.11			//MEDIA_MODE?
			pKeymap=MEDIAKeyMapTab_AKIRA;
			break;
...
#endif
		default:
			pKeymap=DefaultKeyMapTab_AKIRA;
			break;
