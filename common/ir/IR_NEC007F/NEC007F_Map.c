...
#include "NEC007F_Map.h"

typedef	struct _stNEC007F_DTVKeyMAP
{
...
stNEC007F_DTVKeymap	TVKeyMapTab_NEC007F[]=
{
...
stNEC007F_DTVKeymap	DTVKeyMapTab_NEC007F[]=
{
	{CMD_PREV,					CMD_TT_MIX},
	{CMD_NEXT,					CMD_TT_REVEAL},	
	{CMD_FFWD, 					CMD_TT_HOLD},
...
stNEC007F_DTVKeymap	AVKeyMapTab_NEC007F[]=
{
...
stNEC007F_DTVKeymap	PCKeyMapTab_NEC007F[]=
{
	{CMD_DTV_RDO_JUMP,		CMD_SWITCH_TO_DTV},
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stNEC007F_DTVKeymap	HDMIKeyMapTab_NEC007F[]=
{
	{CMD_DTV_RDO_JUMP,		CMD_SWITCH_TO_DTV},
	{CMD_EPG,				CMD_STOP},
	{CMD_NOP,					CMD_NOP},
...
stNEC007F_DTVKeymap MEDIAKeyMapTab_NEC007F[] =
{
...
stNEC007F_DTVKeymap	TTKeyMapTab_NEC007F[]=
{	
	{CMD_PREV,					CMD_TT_MIX},
	{CMD_NEXT,					CMD_TT_REVEAL},	
	{CMD_FFWD, 					CMD_TT_HOLD},
...
stNEC007F_DTVKeymap		IPTVKeyMapTab_NEC007F[] =
{
	{CMD_EXIT,					CMD_RETURN},
	{CMD_NOP,					CMD_NOP},
};
stNEC007F_DTVKeymap DefaultKeyMapTab_NEC007F[] ={
	{CMD_NOP,					CMD_NOP},

};

stNEC007F_DTVKeymap DVDKeyMapTab_NEC007F[] ={
	{CMD_DTV_RDO_JUMP,		CMD_SWITCH_TO_DTV},
	{CMD_NOP,					CMD_NOP},
};
stNEC007F_DTVKeymap RECKeyMapTab_NEC007F[] = {
	{CMD_PREV,					CMD_TT_MIX},
	{CMD_NEXT,					CMD_TT_REVEAL},	
	{CMD_FFWD, 					CMD_TT_HOLD},
	{CMD_FRWD,					CMD_TELETEXT},
...
static stNEC007F_DTVKeymap DVDKeyMapTab[]=
{
	/*
...
extern stNEC007F_DTVKeymap DVD_key[4];
extern unsigned int custome_code;
stNEC007F_DTVKeymap *pDVD_key = ( stNEC007F_DTVKeymap *)DVDKeyMapTab;
...
int remote_NEC007F_nec(int code)
{
	stNEC007F_DTVKeymap* pKeymap=NULL;
	int   cDscIrKey=0;
	int   cDscIrSWKey=0;
	int i =0;
	...
	if((code & 0x0000ffff) != NEC007F_CUSTOMER)
	    return -1;
	...
	switch (source)
	{
		case SOURCE_IDTV1:
			...
			if(HK_GetTT_Enable())
				pKeymap=TTKeyMapTab_NEC007F;
			else	
			{
				if(TvApi_GetIDtvSubSource() >= 1)
				{
					if( TvApi_IsRecording() == true )
						pKeymap=RECKeyMapTab_NEC007F;
					else
						pKeymap=DTVKeyMapTab_NEC007F;
				}
				else
				{
					if( TvApi_IsRecording() == true )
		...
		case SOURCE_PLAYBACK:
			...
			{
				pKeymap = IPTVKeyMapTab_NEC007F;
			}
			else
			{
				pKeymap=MEDIAKeyMapTab_NEC007F;
			}
			break;
		
#if defined(ENABLE_DVD_SOURCE)
		case SOURCE_YPP2:
			pKeymap=DVDKeyMapTab_NEC007F;
			break;
#endif
		default:
			pKeymap=DefaultKeyMapTab_NEC007F;
			break;
