...
typedef	struct _stC3230_DTVKeyMAP
{
	int	oriIRKey;
	int	dstIRKey;
}stC3230_DTVKeymap;

int stC3230_Keymap[0x100] = {
/*0x00, 0x01 ,0x02, 0x03*/	CMD_NOP, CMD_MUTE, CMD_POWER, CMD_NOP,//
/*0x04, 0x05 ,0x06, 0x07*/	CMD_ONE, CMD_TWO, CMD_THREE, CMD_VOL_UP,
/*0x08, 0x09 ,0x0a, 0x0b*/	CMD_FOUR, CMD_FIVE, CMD_SIX, CMD_VOL_DOWN,
/*0x0c, 0x0d ,0x0e, 0x0f*/	CMD_SEVEN, CMD_EIGHT, CMD_NINE, CMD_SOUND_MODE,//CMD_DASH

/*0x10, 0x11 ,0x12, 0x13*/	CMD_CHANNEL_DEC, CMD_ZERO, CMD_CHANNEL_INC, CMD_JUMP,
/*0x14, 0x15 ,0x16, 0x17*/	CMD_OPTION_GREEN, CMD_OPTION_YELLOW, CMD_OPTION_BLUE, CMD_NOP,
/*0x18, 0x19 ,0x1a, 0x1b*/	CMD_NOP, CMD_NOP, CMD_DISPLAY, CMD_PICTURE_MODE,
#if defined(ENABLE_TTX_SUBPAGE_BEHAVIOR_2)

#if defined(SIMPLE_RECORD)
/*0x1c, 0x1d ,0x1e, 0x1f*/	CMD_NOP, CMD_NOP, CMD_OPTION_SUBPAGE, CMD_SOURCE,
#else
/*0x1c, 0x1d ,0x1e, 0x1f*/	CMD_POWER, CMD_NOP, CMD_OPTION_SUBPAGE, CMD_SOURCE,//
#endif
#endif
/*0x20, 0x21 ,0x22, 0x23*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_NOP,
/*0x24, 0x25 ,0x26, 0x27*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_NEXT,
/*0x28, 0x29 ,0x2a, 0x2b*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_NOP,
/*0x2c, 0x2d ,0x2e, 0x2f*/	CMD_LIST, CMD_EXIT, CMD_NOP, CMD_NOP,
...
/*0x3c, 0x3d ,0x3e, 0x3f*/	CMD_NOP, CMD_NOP, CMD_TELETEXT_SUBTITLE, CMD_NOP,

/*0x40, 0x41 ,0x42, 0x43*/	CMD_FAVCH_DOWN, CMD_NOP, CMD_NOP, CMD_DISPLAY_RATIO,
#if defined(SIMPLE_RECORD)
/*0x44, 0x45 ,0x46, 0x47*/	CMD_NOP, CMD_PLAY_PAUSE, CMD_STOP,CMD_FRWD,//CMD_PVR_FILE_LIST CMD_PVR_SCHEDULE_LIST,
#else
/*0x44, 0x45 ,0x46, 0x47*/	CMD_NOP, CMD_PLAY_PAUSE,CMD_STOP, CMD_FRWD,
#endif
/*0x48, 0x49 ,0x4a, 0x4b*/	CMD_FFWD, CMD_DTV_RDO_JUMP, CMD_PREV, CMD_MENU,//CMD_SLEEP,
/*0x4c, 0x4d ,0x4e, 0x4f*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_PVR_RECORD,

/*0x50, 0x51 ,0x52, 0x53*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_NOP,
/*0x54, 0x55 ,0x56, 0x57*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_NOP,
/*0x58, 0x59 ,0x5a, 0x5b*/	CMD_RETURN, CMD_NOP, CMD_USB, CMD_NOP,//CMD_FAVCH_UP
/*0x5c, 0x5d ,0x5e, 0x5f*/	CMD_NOP, CMD_NOP, CMD_FREEZE, CMD_NOP,


/*0x60, 0x61 ,0x62, 0x63*/	CMD_UP, CMD_DOWN, CMD_RIGHT, CMD_NOP,
/*0x64, 0x65 ,0x66, 0x67*/	CMD_NOP, CMD_LEFT, CMD_NOP, CMD_NOP,
/*0x68, 0x69 ,0x6a, 0x6b*/	CMD_ENTER, CMD_NOP, CMD_NOP, CMD_AUDIO,
/*0x6c, 0x6d ,0x6e, 0x6f*/	CMD_OPTION_RED, CMD_NOP, CMD_NOP, CMD_NOP,

/*0x70, 0x71 ,0x72, 0x73*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_NOP,
/*0x74, 0x75 ,0x76, 0x77*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_NOP,
/*0x78, 0x79 ,0x7a, 0x7b*/	CMD_NOP, CMD_EPG, CMD_NOP, CMD_NOP,
...
/*0x8c, 0x8d ,0x8e, 0x8f*/	CMD_TELETEXT, CMD_NOP, CMD_NOP, CMD_NOP,

/*0x90, 0x91 ,0x92, 0x93*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_RETURN,
/*0x94, 0x95 ,0x96, 0x97*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_NOP,
/*0x98, 0x99 ,0x9a, 0x9b*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_NOP,
/*0x9c, 0x9d ,0x9e, 0x9f*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_FAVCH,
...
stC3230_DTVKeymap		TVKeyMapTab_C3230[]=
{
	{CMD_TELETEXT_SUBTITLE,		CMD_STITLE},
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--start
stC3230_DTVKeymap		DTVKeyMapTab_C3230[]=
{
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--end
stC3230_DTVKeymap		AVKeyMapTab_C3230[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stC3230_DTVKeymap		PCKeyMapTab_C3230[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stC3230_DTVKeymap		HDMIKeyMapTab_C3230[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stC3230_DTVKeymap		MEDIAKeyMapTab_C3230[]=
{
	{CMD_FAVCH, 					CMD_QUICK},
	{CMD_EXIT,					CMD_RETURN},
	{CMD_TT_TXCL,				CMD_NOP},
...
stC3230_DTVKeymap		DVDKeyMapTab_C3230[]=
{	// IR_CMD				DVD_CODE
	{CMD_MUTE,					0x003C},
	{CMD_NOP,					CMD_NOP},
};
stC3230_DTVKeymap		DefaultKeyMapTab_C3230[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};	

stC3230_DTVKeymap		TTKeyMapTab_C3230[]=
{
	{CMD_PREV,					CMD_TT_MIX},
	{CMD_PLAY_PAUSE, 				CMD_TT_HOLD},
	{CMD_FRWD, 			CMD_TT_REVEAL},
	{CMD_STOP,					CMD_TT_INDEX},
	{CMD_FFWD,			CMD_WIDE},
...
stC3230_DTVKeymap		RECKeyMapTab_C3230[]=
{
	{CMD_NOP,					CMD_NOP},
};
...
static stC3230_DTVKeymap DVDKeyMapTab[]=
{
...
/*************************************************************************************************************************************/
extern stC3230_DTVKeymap DVD_key[4];
extern unsigned int custome_code;
stC3230_DTVKeymap *pDVD_key = ( stC3230_DTVKeymap *)DVDKeyMapTab;
...
int remote_C3230_nec(int code)
{
	stC3230_DTVKeymap* pKeymap=NULL;
	int   cDscIrKey=0;
	int   cDscIrSWKey=0;
	int i =0;
	...
	if((code & 0x0000ffff) != C3230_CUSTOMER)
	    return -1;
	...
	switch (source)
	{
			...
			//add by lq@2014.12.16--start
			{
				if(TvApi_GetIDtvSubSource() >= 1)
				{
					...
					if( TvApi_IsRecording() == true )
						pKeymap=RECKeyMapTab_C3230;
					else
					#endif
						pKeymap=DTVKeyMapTab_C3230;
				}
				else
				{
					#ifndef BUILD_TV036_2_ISDB	
		...
		case SOURCE_HDMI3:
			pKeymap=HDMIKeyMapTab_C3230;
			break;
		
		case SOURCE_BROWSER:
		case SOURCE_OSD:
		case SOURCE_PLAYBACK://add by zjl@2014.06.11
			pKeymap=MEDIAKeyMapTab_C3230;
			break;
...
#endif
		default:
			pKeymap=DefaultKeyMapTab_C3230;
			break;
...
int stC3230_Keymap[0x100] = {
/*0x00, 0x01 ,0x02, 0x03*/	CMD_NOP, CMD_MUTE, CMD_POWER, CMD_NOP,
/*0x04, 0x05 ,0x06, 0x07*/	CMD_ONE, CMD_TWO, CMD_NOP, CMD_VOL_UP,//CMD_RIGHT,CMD_CHANNEL_DEC,CMD_ENTER
/*0x08, 0x09 ,0x0a, 0x0b*/	CMD_FOUR, CMD_FIVE, CMD_SIX, CMD_VOL_DOWN,//CMD_CHANNEL_INC 
/*0x0c, 0x0d ,0x0e, 0x0f*/	CMD_SEVEN, CMD_EIGHT,CMD_NINE, CMD_SOUND_MODE,//CMD_ZERO

/*0x10, 0x11 ,0x12, 0x13*/	CMD_CHANNEL_DEC, CMD_ZERO, CMD_CHANNEL_INC,CMD_JUMP,
/*0x14, 0x15 ,0x16, 0x17*/	CMD_OPTION_GREEN, CMD_OPTION_YELLOW, CMD_OPTION_BLUE, CMD_NOP,//CMD_FOUR,CMD_THREE
/*0x18, 0x19 ,0x1a, 0x1b*/	CMD_NOP, CMD_NOP, CMD_DISPLAY, CMD_VIDEO,//CMD_UP
/*0x1c, 0x1d ,0x1e, 0x1f*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_SOURCE,
...
/*0x40, 0x41 ,0x42, 0x43*/	CMD_NOP, CMD_PLAY, CMD_NOP, CMD_DISPLAY_RATIO,//CMD_EPG
/*0x44, 0x45 ,0x46, 0x47*/	CMD_NOP, CMD_PLAY_PAUSE, CMD_STOP, CMD_FRWD,
/*0x48, 0x49 ,0x4a, 0x4b*/	CMD_FFWD, CMD_DTV_RDO_JUMP, CMD_PREV, CMD_MENU,//CMD_SLEEP,
/*0x4c, 0x4d ,0x4e, 0x4f*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_PVR_RECORD,//CMD_POINT,

/*0x50, 0x51 ,0x52, 0x53*/	CMD_NOP, CMD_NOP, CMD_CAPTION, CMD_NOP,
/*0x54, 0x55 ,0x56, 0x57*/	CMD_ONE, CMD_NOP, CMD_NOP, CMD_NOP,
/*0x58, 0x59 ,0x5a, 0x5b*/	CMD_RETURN, CMD_NOP, CMD_USB, CMD_NOP,
/*0x5c, 0x5d ,0x5e, 0x5f*/	CMD_NOP, CMD_NOP, CMD_FREEZE, CMD_NOP,
