...
typedef	struct _stRH21_DTVKeyMAP
{
	int	oriIRKey;
	int	dstIRKey;
}stRH21_DTVKeymap;

int stRH21_Keymap[0x100] = {
/*0x00, 0x01 ,0x02, 0x03*/	CMD_POWER, CMD_MUTE, CMD_ONE, CMD_TWO,
/*0x04, 0x05 ,0x06, 0x07*/	CMD_THREE, CMD_FOUR, CMD_FIVE, CMD_SIX,
/*0x08, 0x09 ,0x0a, 0x0b*/	CMD_SEVEN, CMD_EIGHT, CMD_NINE, CMD_AD_SWITCH,
/*0x0c, 0x0d ,0x0e, 0x0f*/	CMD_ZERO, CMD_JUMP, CMD_NOP, CMD_SOURCE,

/*0x10, 0x11 ,0x12, 0x13*/	CMD_ENTER, CMD_LEFT, CMD_RIGHT, CMD_UP,
/*0x14, 0x15 ,0x16, 0x17*/	CMD_DOWN, CMD_EXIT, CMD_MENU, CMD_TELETEXT,
/*0x18, 0x19 ,0x1a, 0x1b*/	CMD_EIGHT, CMD_NINE, CMD_NOP, CMD_ZERO,
/*0x1c, 0x1d ,0x1e, 0x1f*/	CMD_DASH, CMD_VOL_UP, CMD_PLAY_PAUSE, CMD_NOP,
...
/*0x44, 0x45 ,0x46, 0x47*/	CMD_DISPLAY_RATIO, CMD_PVR_RECORD, CMD_NOP, CMD_UP,
...
/*0x50, 0x51 ,0x52, 0x53*/	CMD_FAVCH, CMD_PLAY_PAUSE, CMD_STOP, CMD_FAVCH_UP,
/*0x54, 0x55 ,0x56, 0x57*/	CMD_PREV, CMD_NEXT, CMD_FRWD, CMD_FFWD,
/*0x58, 0x59 ,0x5a, 0x5b*/	CMD_DTV_RDO_JUMP, CMD_TELETEXT_SUBTITLE, CMD_PVR_RECORD, CMD_RIGHT,
/*0x5c, 0x5d ,0x5e, 0x5f*/	CMD_PVR_TIMESHIFT, CMD_FAVCH_DOWN, CMD_TT_REVEAL, CMD_NOP,


/*0x60, 0x61 ,0x62, 0x63*/	CMD_SLEEP, CMD_AUDIO, CMD_EPG, CMD_SOUND_MODE,
/*0x64, 0x65 ,0x66, 0x67*/	CMD_DISPLAY, CMD_SLEEP, CMD_TELETEXT_SUBTITLE, CMD_DTV_RDO_JUMP,
/*0x68, 0x69 ,0x6a, 0x6b*/	CMD_USB, CMD_DISPLAY_RATIO, CMD_PC_AUTO_ADJUST, CMD_HDMI,
/*0x6c, 0x6d ,0x6e, 0x6f*/	CMD_OPTION_RED, CMD_OPTION_GREEN, CMD_OPTION_YELLOW, CMD_OPTION_BLUE,
...
stRH21_DTVKeymap		TVKeyMapTab_RH21[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--start
stRH21_DTVKeymap		DTVKeyMapTab_RH21[]=
{
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--end
stRH21_DTVKeymap		AVKeyMapTab_RH21[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stRH21_DTVKeymap		PCKeyMapTab_RH21[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stRH21_DTVKeymap		HDMIKeyMapTab_RH21[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stRH21_DTVKeymap		MEDIAKeyMapTab_RH21[]=
{
	{CMD_MENU, 					CMD_QUICK},
	{CMD_EXIT,					CMD_RETURN},
	{CMD_TT_TXCL,				CMD_NOP},
	{CMD_TELETEXT,				CMD_NOP},
	{CMD_TT_REVEAL,				CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stRH21_DTVKeymap		DVDKeyMapTab_RH21[]=
{	// IR_CMD				DVD_CODE
	//{CMD_MUTE,				0x003C},
	{CMD_NOP,					CMD_NOP},
};
stRH21_DTVKeymap		DefaultKeyMapTab_RH21[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};	

stRH21_DTVKeymap		TTKeyMapTab_RH21[]=
{
	...
	#define	DVD_IR_CUSTOMER		0x01FE		// DVD Custom Code
static stRH21_DTVKeymap DVDKeyMapTab[]=
{
	{CMD_ZERO,						0x0e},//4
	{CMD_ONE,						0x0d},//4
	{CMD_TWO,						0x19},//4
...
int remote_RH21_nec(int code)
{
	stRH21_DTVKeymap* pKeymap=NULL;
	int   cDscIrKey=0;
	int   cDscIrSWKey=0;
	int i =0;
	...
	if((code & 0x0000ffff) != RH21_CUSTOMER)
	    return -1;
	...
	switch (source)
	{
		case SOURCE_IDTV1:
			...
			if(HK_GetTT_Enable())
				pKeymap=TTKeyMapTab_RH21;
			else
			//modify by zjl@2014.09.01--start	
			{
				if(TvApi_GetIDtvSubSource() >= 1)
					pKeymap=DTVKeyMapTab_RH21;
				else
					pKeymap=TVKeyMapTab_RH21;
			}
		...
		case SOURCE_HDMI3:
			pKeymap=HDMIKeyMapTab_RH21;
			break;
		
		case SOURCE_BROWSER:
		case SOURCE_OSD:
		case SOURCE_PLAYBACK://add by zjl@2014.06.11
			pKeymap=MEDIAKeyMapTab_RH21;
			break;
