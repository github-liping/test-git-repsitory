...
#include "ZHJPRS41_Map.h"

typedef	struct _stALTRN_DTVKeyMAP
{
	int	oriIRKey;
	int	dstIRKey;
}stALTRN_DTVKeymap;

int stALTRN_Keymap[0x100] = {
...
/*0x18, 0x19 ,0x1a, 0x1b*/	CMD_SOURCE, CMD_NOP, CMD_NOP, CMD_NOP,
...
/*0x3c, 0x3d ,0x3e, 0x3f*/	CMD_DTV_RDO_JUMP, CMD_NOP, CMD_NOP, CMD_NOP,
/*0x40, 0x41 ,0x42, 0x43*/	CMD_DTV_RDO_JUMP, CMD_NOP, CMD_PICTURE_MODE, CMD_SOUND_MODE,
/*0x44, 0x45 ,0x46, 0x47*/	CMD_PVR_TIMESHIFT, CMD_TT_REVEAL, CMD_TELETEXT_SUBTITLE, CMD_PVR_RECORD,
/*0x48, 0x49 ,0x4a, 0x4b*/	CMD_EPG, CMD_TT_INDEX, CMD_TT_HOLD, CMD_AUDIO,
/*0x4c, 0x4d ,0x4e, 0x4f*/	CMD_OPTION_SUBPAGE, CMD_OPTION_RED, CMD_OPTION_GREEN, CMD_OPTION_YELLOW,
/*0x50, 0x51 ,0x52, 0x53*/	CMD_OPTION_BLUE, CMD_PLAY_PAUSE, CMD_STOP, CMD_NOP,
/*0x54, 0x55 ,0x56, 0x57*/	CMD_TELETEXT, CMD_NEXT, CMD_FRWD, CMD_FFWD,
...
stALTRN_DTVKeymap		TVKeyMapTab_ALTRN[]=
{
...
stALTRN_DTVKeymap		DTVKeyMapTab_ALTRN[]=
{
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--end
stALTRN_DTVKeymap		AVKeyMapTab_ALTRN[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stALTRN_DTVKeymap		PCKeyMapTab_ALTRN[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stALTRN_DTVKeymap		HDMIKeyMapTab_ALTRN[]=
{
	{CMD_EXIT,					CMD_RETURN},
	{CMD_TT_INDEX,				CMD_FRWD},
	{CMD_TT_HOLD,				CMD_FFWD},
	{CMD_TT_REVEAL,				CMD_PREV},
	{CMD_OPTION_SUBPAGE,		CMD_NEXT},
	{CMD_EPG,					CMD_STOP},
	{CMD_PVR_TIMESHIFT,			CMD_PLAY_PAUSE},
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stALTRN_DTVKeymap		MEDIAKeyMapTab_ALTRN[]=
{
	{CMD_PVR_TIMESHIFT,			CMD_PLAY_PAUSE},
	{CMD_TT_INDEX,				CMD_FRWD},
	{CMD_TT_HOLD,				CMD_FFWD},
...
stALTRN_DTVKeymap		DVDKeyMapTab_ALTRN[]=
{	// IR_CMD				DVD_CODE
	//{CMD_MUTE,					0x003C},
	{CMD_NOP,					CMD_NOP},
};
stALTRN_DTVKeymap		DefaultKeyMapTab_ALTRN[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};	

stALTRN_DTVKeymap		TTKeyMapTab_ALTRN[]=
{
...
stALTRN_DTVKeymap		RECKeyMapTab_ALTRN[]=
{
    //{CMD_EPG,				    CMD_STOP},
	{CMD_NOP,					CMD_NOP},
};
...
static stALTRN_DTVKeymap DVDKeyMapTab[]=
{
...
/*************************************************************************************************************************************/
extern stALTRN_DTVKeymap DVD_key[4];
extern unsigned int custome_code;
stALTRN_DTVKeymap *pDVD_key = ( stALTRN_DTVKeymap *)DVDKeyMapTab;
...
int remote_ZHJPRS41_nec(int code)
{
	stALTRN_DTVKeymap* pKeymap=NULL;
	int   cDscIrKey=0;
	int   cDscIrSWKey=0;
	int i =0;
	...
	if((code & 0x0000ffff) != ZHJPRS41_CUSTOMER)
	    return -1;
	...
	switch (source)
	{
			...
			//add by lq@2014.12.16--start
			{
				if(TvApi_GetIDtvSubSource() >= 1)
				{
					if( TvApi_IsRecording() == true )
						pKeymap=RECKeyMapTab_ALTRN;
					else
						pKeymap=DTVKeyMapTab_ALTRN;
				}
				else
				{
					if( TvApi_IsRecording() == true )
		...
		case SOURCE_HDMI3:
			pKeymap=HDMIKeyMapTab_ALTRN;
			break;
		
		case SOURCE_BROWSER:
		case SOURCE_OSD:
		case SOURCE_PLAYBACK://add by zjl@2014.06.11
			pKeymap=MEDIAKeyMapTab_ALTRN;
			break;
...
#endif
		default:
			pKeymap=DefaultKeyMapTab_ALTRN;
			break;
