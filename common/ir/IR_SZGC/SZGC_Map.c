...
typedef	struct _stSZGC_DTVKeyMAP
{
	int	oriIRKey;
	int	dstIRKey;
}stSZGC_DTVKeymap;

int stSZGC_Keymap[0x100] = {
...
/*0x80, 0x81 ,0x82, 0x83*/	CMD_CHANNEL_INC, CMD_STOP, CMD_TT_REVEAL, CMD_VOL_UP,
/*0x84, 0x85 ,0x86, 0x87*/	CMD_NOP, CMD_NOP, CMD_VOL_DOWN, CMD_NOP,
/*0x88, 0x89 ,0x8a, 0x8b*/	CMD_NOP, CMD_NOP, CMD_DISPLAY, CMD_NOP,
/*0x8c, 0x8d ,0x8e, 0x8f*/	CMD_DASH, CMD_NOP, CMD_CHANNEL_DEC, CMD_NOP,
...
/*0xa4, 0xa5 ,0xa6, 0xa7*/	CMD_NOP, CMD_NOP, CMD_OPTION_GREEN, CMD_PLAY_PAUSE,
/*0xa8, 0xa9 ,0xaa, 0xab*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_NOP,
/*0xac, 0xad ,0xae, 0xaf*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_NOP,

/*0xb0, 0xb1 ,0xb2, 0xb3*/	CMD_NOP, CMD_OPTION_BLUE, CMD_NOP, CMD_NOP,
...
/*0xc0, 0xc1 ,0xc2, 0xc3*/	CMD_EPG, CMD_TELETEXT_SUBTITLE, CMD_OPTION_SUBPAGE, CMD_SOURCE,
/*0xc4, 0xc5 ,0xc6, 0xc7*/	CMD_NOP, CMD_NOP, CMD_TELETEXT, CMD_TT_INDEX,
/*0xc8, 0xc9 ,0xca, 0xcb*/	CMD_OPTION_YELLOW, CMD_NOP, CMD_DISPLAY_RATIO, CMD_FAVCH,
/*0xcc, 0xcd ,0xce, 0xcf*/	CMD_OPTION_RED, CMD_NOP, CMD_AUDIO, CMD_LIST,

/*0xd0, 0xd1 ,0xd2, 0xd3*/	CMD_NOP, CMD_NOP, CMD_NOP, CMD_NOP,
/*0xd4, 0xd5 ,0xd6, 0xd7*/	CMD_MENU, CMD_PVR_RECORD, CMD_FOUR, CMD_POWER,
/*0xd8, 0xd9 ,0xda, 0xdb*/	CMD_DOWN, CMD_ZERO, CMD_FIVE, CMD_TT_HOLD,
...
stSZGC_DTVKeymap		TVKeyMapTab_SZGC[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--start
stSZGC_DTVKeymap		DTVKeyMapTab_SZGC[]=
{
	{CMD_NOP,					CMD_NOP},
};
//add by zjl@2014.09.01--end
stSZGC_DTVKeymap		AVKeyMapTab_SZGC[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stSZGC_DTVKeymap		PCKeyMapTab_SZGC[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stSZGC_DTVKeymap		HDMIKeyMapTab_SZGC[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};
stSZGC_DTVKeymap		MEDIAKeyMapTab_SZGC[]=
{
	{CMD_MENU, 					CMD_QUICK},
	{CMD_EXIT,					CMD_RETURN},
	{CMD_TT_TXCL,				CMD_NOP},
...
stSZGC_DTVKeymap		DVDKeyMapTab_SZGC[]=
{	// IR_CMD				DVD_CODE
	{CMD_MUTE,					0x003C},
	{CMD_NOP,					CMD_NOP},
};
stSZGC_DTVKeymap		DefaultKeyMapTab_SZGC[]=
{
	{CMD_NOP,					CMD_NOP},
	{CMD_NOP,					CMD_NOP},
};	

stSZGC_DTVKeymap		TTKeyMapTab_SZGC[]=
{
...
stSZGC_DTVKeymap		RECKeyMapTab_SZGC[]=
{
	{CMD_NOP,					CMD_NOP},
};
...
static stSZGC_DTVKeymap DVDKeyMapTab[]=
{
...
/*************************************************************************************************************************************/
extern stSZGC_DTVKeymap DVD_key[4];
extern unsigned int custome_code;
stSZGC_DTVKeymap *pDVD_key = ( stSZGC_DTVKeymap *)DVDKeyMapTab;
...
int remote_SZGC_nec(int code)
{
	stSZGC_DTVKeymap* pKeymap=NULL;
	int   cDscIrKey=0;
	int   cDscIrSWKey=0;
	int i =0;
	...
	if((code & 0x0000ffff) != SZGC_CUSTOMER)
	    return -1;
	...
	switch (source)
	{
			...
			//add by lq@2014.12.16--start
			{
				if(TvApi_GetIDtvSubSource() >= 1)
				{
					if( TvApi_IsRecording() == true )
						pKeymap=RECKeyMapTab_SZGC;
					else
						pKeymap=DTVKeyMapTab_SZGC;
				}
				else
				{
					if( TvApi_IsRecording() == true )
		...
		case SOURCE_HDMI3:
			pKeymap=HDMIKeyMapTab_SZGC;
			break;
		
		case SOURCE_BROWSER:
		case SOURCE_OSD:
		case SOURCE_PLAYBACK://add by zjl@2014.06.11
			pKeymap=MEDIAKeyMapTab_SZGC;
			break;
