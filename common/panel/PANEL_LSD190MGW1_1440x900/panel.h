...
#define CONFIG_DISPLAY_CLOCK_MIN 				88
#define CONFIG_DISPLAY_REFRESH_RATE 			60
#define CONFIG_DISPLAY_CLOCK_TYPICAL 			106.5*1000000//75*1000000

/*
 * Display total window setup
 */
#define CONFIG_DISP_HORIZONTAL_TOTAL			1900
#define CONFIG_DISP_VERTICAL_TOTAL				934
#define CONFIG_DISP_VERTICAL_TOTAL_50Hz_MIN 			1105
#define CONFIG_DISP_VERTICAL_TOTAL_50Hz_MAX 			1135
#define CONFIG_DISP_VERTICAL_TOTAL_60Hz_MIN 			919
#define CONFIG_DISP_VERTICAL_TOTAL_60Hz_MAX 			949
 ...
 */
#define CONFIG_DISP_DEN_STA_HPOS 				230
#define CONFIG_DISP_DEN_END_HPOS 				1670
...
#define CONFIG_DISP_HSYNC_LASTLINE 				1899
...
#define	LVDS_TO_PANEL_OFF_ms					30 // 50	// Delay(T5+T6): LVDS Signal Off --> Panel Power Off
////////////////////////////
//Panel Off--> Next On
////////////////////////////
