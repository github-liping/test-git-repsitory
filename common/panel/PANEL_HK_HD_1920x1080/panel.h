...
#define CONFIG_DISPLAY_CLOCK_TYPICAL 148.5*1000000//74.5*1000000
...
#define CONFIG_DISP_VERTICAL_TOTAL_60Hz_MIN 			1110
...
//On --> Off	Sequence
/////////////////////////////
#define	LIGHT_TO_LDVS_OFF_ms		210//200  // Delay(T4):    Turn Off backlight and delay to turn off LVDS signal
#define	LVDS_TO_PANEL_OFF_ms		50//40   // Delay(T5+T6): LVDS Signal Off --> Panel Power Off
////////////////////////////
//Panel Off--> Next On
////////////////////////////
