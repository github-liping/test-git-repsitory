...
#define CONFIG_DISPLAY_LVDS_PN_SWAP				0	//0:No Swap,1:Swap
...
#define CONFIG_DISPLAY_CLOCK_MAX 				160
#define CONFIG_DISPLAY_CLOCK_MIN 				120
#define CONFIG_DISPLAY_REFRESH_RATE 			60
#define CONFIG_DISPLAY_CLOCK_TYPICAL 			149*1000000

/*
 * Display total window setup
 */
#define CONFIG_DISP_HORIZONTAL_TOTAL			2200
#define CONFIG_DISP_VERTICAL_TOTAL				1125//1136
#define CONFIG_DISP_VERTICAL_TOTAL_50Hz_MIN 			1336//1236
#define CONFIG_DISP_VERTICAL_TOTAL_50Hz_MAX 			1372//1590
#define CONFIG_DISP_VERTICAL_TOTAL_60Hz_MIN 			1114//1030
#define CONFIG_DISP_VERTICAL_TOTAL_60Hz_MAX 			1143//1325 
...
//On --> Off	Sequence
/////////////////////////////
#define	LIGHT_TO_LDVS_OFF_ms					250//90//500//180	// Delay(T4):    Turn Off backlight and delay to turn off LVDS signal
#define	LVDS_TO_PANEL_OFF_ms					120//150//80//25//540//25	// Delay(T5+T6): LVDS Signal Off --> Panel Power Off
////////////////////////////
//Panel Off--> Next On
////////////////////////////
#define	PANEL_OFF_TO_ON_ms						       1000// 500    // Delay(T7):    Totally Off --> Next On
