...
#define CONFIG_DISPLAY_COLOR_BITS 				1	// 0: 30bits, 1:24 bits, 2: 18 bits
...
#define CONFIG_DISPLAY_PORTAB_SWAP				0	// 0: No Swap, 1: Swap   //Ferdie Modify Param 20130219
...
#define CONFIG_DISPLAY_CLOCK_MAX 				149
#define CONFIG_DISPLAY_CLOCK_MIN 				99
#define CONFIG_DISPLAY_REFRESH_RATE 			60
#define CONFIG_DISPLAY_CLOCK_TYPICAL 			1192*100000

/*
 * Display total window setup
 */
#define CONFIG_DISP_HORIZONTAL_TOTAL			1840
#define CONFIG_DISP_VERTICAL_TOTAL				1080
#define CONFIG_DISP_VERTICAL_TOTAL_50Hz_MIN 	1281
#define CONFIG_DISP_VERTICAL_TOTAL_50Hz_MAX 	1311
#define CONFIG_DISP_VERTICAL_TOTAL_60Hz_MIN 	1065
#define CONFIG_DISP_VERTICAL_TOTAL_60Hz_MAX 	1095
...
#define CONFIG_DISP_VSYNC_LENGTH 				2

/*
 * Display Enable window setup
 */
#define CONFIG_DISP_DEN_STA_HPOS 				76
#define CONFIG_DISP_DEN_END_HPOS 				1756
#define CONFIG_DISP_DEN_STA_VPOS 			    16
#define CONFIG_DISP_DEN_END_VPOS 				1066

/*
 * Display active window setup
 */
#define CONFIG_DISP_ACT_STA_HPOS 				0
#define CONFIG_DISP_ACT_END_HPOS 				1680
#define CONFIG_DISP_ACT_STA_VPOS 				0
#define CONFIG_DISP_ACT_END_VPOS 				1050
#define CONFIG_DISP_HSYNC_LASTLINE 				1839
...
//Off --> On Sequence
/////////////////////////////
#define	PANEL_TO_LVDS_ON_ms						30	// Delay(T1+T2): Panel Power --> LVDS Signal
#define	LVDS_TO_LIGHT_ON_ms						450//50 // Delay(T3):    Settings: LVDS Signal --> Backlight On
/////////////////////////////
//On --> Off	Sequence
/////////////////////////////
#define	LIGHT_TO_LDVS_OFF_ms					90//500//180	// Delay(T4):    Turn Off backlight and delay to turn off LVDS signal
#define	LVDS_TO_PANEL_OFF_ms					30 // 150//80//25//540//25	// Delay(T5+T6): LVDS Signal Off --> Panel Power Off
////////////////////////////
//Panel Off--> Next On
////////////////////////////
#define	PANEL_OFF_TO_ON_ms						500//1000// Delay(T7):    Totally Off --> Next On
...
#define CONFIG_BACKLIGHT_PWM_DUTY				100
...
//// Panel Name
/////////////////////////////
#define CONFIG_DISP_PANEL_NAME                  "LG_LM220WE1_1680x1050.h"
