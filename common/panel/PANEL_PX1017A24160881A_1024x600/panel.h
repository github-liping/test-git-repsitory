...
#define CONFIG_DISPLAY_CLOCK_MIN 				40
#define CONFIG_DISPLAY_REFRESH_RATE 			60
#define CONFIG_DISPLAY_CLOCK_TYPICAL 			51.2*1000000
...
#define CONFIG_DISP_VERTICAL_TOTAL_50Hz_MIN 	750//776 // morgan_shen  20120531  for unsmooth  roll titles at TV pal 
#define CONFIG_DISP_VERTICAL_TOTAL_50Hz_MAX 	960//836
#define CONFIG_DISP_VERTICAL_TOTAL_60Hz_MIN 	625//776
#define CONFIG_DISP_VERTICAL_TOTAL_60Hz_MAX 	800//836 
...
#define CONFIG_DISP_DEN_END_HPOS 				1073
#define CONFIG_DISP_DEN_STA_VPOS 				15
#define CONFIG_DISP_DEN_END_VPOS 				615
...
#define CONFIG_DISP_HSYNC_LASTLINE 				1343
...
#define	LVDS_TO_LIGHT_ON_ms						210//200 // Delay(T3):    Settings: LVDS Signal --> Backlight On
/////////////////////////////
//On --> Off	Sequence
/////////////////////////////
#define	LIGHT_TO_LDVS_OFF_ms					220//200	// Delay(T4):    Turn Off backlight and delay to turn off LVDS signal
