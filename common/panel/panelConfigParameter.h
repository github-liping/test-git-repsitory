...
typedef struct _PANEL_CONFIG_PARAMETER{
	...
	UINT8 iCONFIG_DISPLAY_PORTAB_SWAP:5;		//0: No Swap, 1: Swap , 4 port lvds has 24 type mapping tables
	UINT8 iCONFIG_DISPLAY_LVDS_PN_SWAP:1;
	...
	UINT8 iCONFIG_DISPLAY_CLOCK_INVERSE:1;	//1

	UINT8 iCONFIG_DISPLAY_CLOCK_MAX;		//119
	UINT8 iCONFIG_DISPLAY_CLOCK_MIN;
	...
	UINT8 iCONFIG_DISP_DEN_STA_HPOS;// 				200//201//32
...
#ifdef VBY_ONE_PANEL
	UINT16 iCONFIG_DISP_ACT_STA_HPOS:4;// 				0
	UINT16 iCONFIG_DISP_ACT_END_HPOS:13;// 				1280
	UINT16 iCONFIG_DISP_ACT_STA_VPOS:4;// 				0
	UINT16 iCONFIG_DISP_ACT_END_VPOS:13;// 				1024
#else
	UINT16 iCONFIG_DISP_ACT_STA_HPOS:4;// 				0
	UINT16 iCONFIG_DISP_ACT_END_HPOS:12;// 				1280
	UINT16 iCONFIG_DISP_ACT_STA_VPOS:4;// 				0
	UINT16 iCONFIG_DISP_ACT_END_VPOS:12;// 				1024
#endif
	...
	UINT8 iCONFIG_PANEL_TYPE;    // (0:LVDS 2k1k only), (1: VBY_ONE 4k2K), (2: LVDS 4k2k+2k1k (NEED define CUSTOM INDEX)), (3:epi panel),  (4:LvdstoHdmi)
#ifdef CONFIG_PANEL_SG_3D_IR_INDEX
	UINT8 iPANEL_SG_3D_IR_INDEX; 
#endif

	char sPanelName[32];
}PANEL_CONFIG_PARAMETER;
