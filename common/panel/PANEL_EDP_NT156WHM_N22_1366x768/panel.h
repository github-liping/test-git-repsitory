...
#define CONFIG_DISPLAY_CLOCK_TYPICAL 			82*1000000

/*
 * Display total window setup
 */
#define CONFIG_DISP_HORIZONTAL_TOTAL			1560
#define CONFIG_DISP_VERTICAL_TOTAL				879
#define CONFIG_DISP_VERTICAL_TOTAL_50Hz_MIN 	960//776 // morgan_shen  20120531  for unsmooth  roll titles at TV pal 
#define CONFIG_DISP_VERTICAL_TOTAL_50Hz_MAX 	1050//836
#define CONFIG_DISP_VERTICAL_TOTAL_60Hz_MIN		800//776
#define CONFIG_DISP_VERTICAL_TOTAL_60Hz_MAX		940//836 
...
#define	LVDS_TO_PANEL_OFF_ms					5//30 // 40	// Delay(T5+T6): LVDS Signal Off --> Panel Power Off
////////////////////////////
//Panel Off--> Next On
////////////////////////////
