...
#define CONFIG_DISPLAY_COLOR_BITS 				1 // 0: 30bits, 1:24 bits, 2: 18bits
...
#define CONFIG_DISPLAY_CLOCK_MAX 				139
#define CONFIG_DISPLAY_CLOCK_MIN 				80
#define CONFIG_DISPLAY_REFRESH_RATE 			60
#define CONFIG_DISPLAY_CLOCK_TYPICAL 			108*1000000 // hsliao 20081008

/*
 * Display total window setup
 */
#define CONFIG_DISP_HORIZONTAL_TOTAL 					1688
#define CONFIG_DISP_VERTICAL_TOTAL 						1066
#define CONFIG_DISP_VERTICAL_TOTAL_50Hz_MIN 			1237
#define CONFIG_DISP_VERTICAL_TOTAL_50Hz_MAX 			1800
#define CONFIG_DISP_VERTICAL_TOTAL_60Hz_MIN 			1031
#define CONFIG_DISP_VERTICAL_TOTAL_60Hz_MAX 			1500 
/*
 * Display Sync Width setup
 */
#define CONFIG_DISP_HSYNC_WIDTH 				56
#define CONFIG_DISP_VSYNC_LENGTH 				3

/*
 * Display Enable window setup
 */
#define CONFIG_DISP_DEN_STA_HPOS 				124
#define CONFIG_DISP_DEN_END_HPOS 				1404
#define CONFIG_DISP_DEN_STA_VPOS 				28
#define CONFIG_DISP_DEN_END_VPOS 				1052
/*
...
#define CONFIG_DISP_HSYNC_LASTLINE 				1687
#define CONFIG_DISP_DCLK_DELAY 					0


#define _CONFIG_DISP_ACT_STA_BIOS 				0x00
#define CONFIG_DEFAULT_DPLL_M_DIVIDER			0xb2 //hpwang 20071119 set default DCLK=(27*104/8)/2/2=87.75MHz
...
//// Panel Name
/////////////////////////////
#define CONFIG_DISP_PANEL_NAME                  "SAM_LM170ET01_1280x1024.h"
