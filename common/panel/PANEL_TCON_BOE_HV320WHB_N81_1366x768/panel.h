...
#define CONFIG_DISPLAY_CLOCK_MIN 				56//63
#define CONFIG_DISPLAY_REFRESH_RATE 			60
#define CONFIG_DISPLAY_CLOCK_TYPICAL 			75.4*1000000//75*1000000

/*
 * Display total window setup
 */
#define CONFIG_DISP_HORIZONTAL_TOTAL			1560//1560
#define CONFIG_DISP_VERTICAL_TOTAL				808
#define CONFIG_DISP_VERTICAL_TOTAL_50Hz_MIN 	778
#define CONFIG_DISP_VERTICAL_TOTAL_50Hz_MAX 	1200  //modify by tanar for YPbPr 运动图像卡顿 20150427
#define CONFIG_DISP_VERTICAL_TOTAL_60Hz_MIN 	790  //778//776 /* CONFIG_DISP_VERTICAL_TOTAL_60Hz_MIN >= CONFIG_DISP_DEN_END_VPOS + CONFIG_DISP_VSYNC_LENGTH */ //Add by wangld @ 2018.3.15
#define CONFIG_DISP_VERTICAL_TOTAL_60Hz_MAX 	1200//836   //modify by tanar for YPbPr 运动图像卡顿 20150427
 ...
 */
#define CONFIG_DISP_DEN_STA_HPOS 				112
#define CONFIG_DISP_DEN_END_HPOS 				1478
#define CONFIG_DISP_DEN_STA_VPOS 				16
#define CONFIG_DISP_DEN_END_VPOS 				784
...
#define CONFIG_DISP_HSYNC_LASTLINE 				1606
...
//Off --> On Sequence
/////////////////////////////
#define	PANEL_TO_LVDS_ON_ms						30//50	// Delay(T1+T2): Panel Power --> LVDS Signal
#define	LVDS_TO_LIGHT_ON_ms						600 // Delay(T3):    Settings: LVDS Signal --> Backlight On
/////////////////////////////
//On --> Off	Sequence
/////////////////////////////
#define	LIGHT_TO_LDVS_OFF_ms					300	// Delay(T4):    Turn Off backlight and delay to turn off LVDS signal
...
//Backlight
////////////////////////////
#define CONFIG_BACKLIGHT_PWM_FREQ				200		// 背光PWM频率
#define CONFIG_BACKLIGHT_PWM_DUTY				235//255	//pengxq 150427 高创要求背光电流在360mA左右(目前硬件最大380mA)
...
//VFLIP Switch
////////////////////////////
#ifdef CONFIG_HKC_RTD2936P560 //Add by wangld @ 2018.3.15
...
//// Panel Name
/////////////////////////////
#define CONFIG_DISP_PANEL_NAME                  "TCON_N81.h"
//#define OPEN_CELL_PANEL			
