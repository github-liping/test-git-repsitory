...
//#define CONFIG_CH_FIVEKEY YES
#define BUILD_DVB_SI_EWS_INDONESIA NO
...
#define K3 CMD_KPD_DOWN // 0x60, 0x7f
#define K4 CMD_POWER // 0x80, 0x9f
#define K5 CMD_KPD_LEFT // 0xa0, 0xbf
#define K6 CMD_KPD_RIGHT // 0xc0, 0xdf
...
#define CONFIG_CUSTOMER_NTWY    //客户南通伟越的客制化宏；
// Area
#define   AREA_IRAQ

// Backlight current function define 
#define DUTY_RANGE {0,100}
#define CUSTOMER_NTWY_ENABLE_NTSC  //add for defined video color is ntsc
