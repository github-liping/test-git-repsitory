...
#define HK_ENABLE_ICU_COMPLEX_LAYOUT YES

#define HK_ENABLE_HDMI13_SWAP NO
#define HIKEEN_UI NO

#define ENABLE_POWER_KEY_EXIT_BURNMODE
#define PowerOnMode_Remember YES
...
#define K6 CMD_KPD_DOWN //0xc0, 0xdf
#define K7 CMD_NOP
...
#define SWISS_ENCODING	//for PERSIAN encoding in usb video
#define CUSTOM_CHANGJIA2938
