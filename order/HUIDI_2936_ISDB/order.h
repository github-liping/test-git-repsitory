...
#define HK_ENABLE_HDMI13_SWAP    YES
...
#define K0 CMD_MENU // 0x0, 0x0
#define K1 CMD_CHANNEL_INC // 0x20, 0x3f
#define K2 CMD_CHANNEL_DEC // 0x40, 0x5f
#define K3 CMD_SOURCE // 0x60, 0x7f
#define K4 CMD_VOL_UP// 0x80, 0x9f
#define K5 CMD_VOL_DOWN // 0xa0, 0xbf
...
//Atv default
#define CUSTOM_VIDEO_SYSTEM	RT_COLOR_STD_NTSC
#define CUSTOM_AUDIO_SYSTEM	RT_ATV_SOUND_SYSTEM_MN
